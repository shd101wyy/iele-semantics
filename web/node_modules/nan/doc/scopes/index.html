    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h2>Scopes</h2>
...
<p>A simple wrapper around <a href="https://v8docs.nodesource.com/node-8.16/d3/d95/classv8_1_1_handle_scope.html" target="_blank" rel="noopener"><code>v8::HandleScope</code></a>.</p>
<p>Definition:</p>
<pre class="hljs"><code><span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Nan</span>:</span>:HandleScope {
...
<p>Example:</p>
<pre class="hljs"><code><span class="hljs-comment">// new object is created, it needs a new scope:</span>
...
<p>Definition:</p>
<pre class="hljs"><code><span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Nan</span>:</span>:EscapableHandleScope {
 <span class="hljs-keyword">public</span>:
  Nan::EscapableHandleScope();
  <span class="hljs-function"><span class="hljs-keyword">static</span> <span class="hljs-keyword">int</span> <span class="hljs-title">NumberOfHandles</span><span class="hljs-params">()</span></span>;
  <span class="hljs-function"><span class="hljs-keyword">template</span>&lt;<span class="hljs-keyword">typename</span> T&gt; v8::Local&lt;T&gt; <span class="hljs-title">Escape</span><span class="hljs-params">(v8::Local&lt;T&gt; value)</span></span>;
}
</code></pre>
<p>Use <code>Escape(value)</code> to return the object.</p>
<p>Example:</p>
<pre class="hljs"><code><span class="hljs-function">v8::Local&lt;v8::Object&gt; <span class="hljs-title">EmptyObj</span><span class="hljs-params">()</span> </span>{
