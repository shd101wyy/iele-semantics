    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h2>Strings &amp; Bytes</h2>
...
<p>Definition:</p>
<pre class="hljs"><code><span class="hljs-keyword">enum</span> Nan::Encoding { ASCII, UTF8, BASE64, UCS2, BINARY, HEX, BUFFER }
</code></pre>
...
<p>Signature:</p>
<pre class="hljs"><code><span class="hljs-function">v8::Local&lt;v8::Value&gt; <span class="hljs-title">Nan::Encode</span><span class="hljs-params">(<span class="hljs-keyword">const</span> <span class="hljs-keyword">void</span> *buf,
                                 <span class="hljs-keyword">size_t</span> len,
                                 <span class="hljs-keyword">enum</span> Nan::Encoding encoding = BINARY)</span></span>;
</code></pre>
...
<p>Signature:</p>
<pre class="hljs"><code><span class="hljs-function"><span class="hljs-keyword">ssize_t</span> <span class="hljs-title">Nan::DecodeBytes</span><span class="hljs-params">(v8::Local&lt;v8::Value&gt; val,
                         <span class="hljs-keyword">enum</span> Nan::Encoding encoding = BINARY)</span></span>;
</code></pre>
...
<p>Signature:</p>
<pre class="hljs"><code><span class="hljs-function"><span class="hljs-keyword">ssize_t</span> <span class="hljs-title">Nan::DecodeWrite</span><span class="hljs-params">(<span class="hljs-keyword">char</span> *buf,
                         <span class="hljs-keyword">size_t</span> len,
