    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Async-Limiter</h1>
<p>A module for limiting concurrent asynchronous actions in flight. Forked from <a href="https://github.com/jessetane/queue" target="_blank" rel="noopener">queue</a>.</p>
<p><a href="http://www.npmjs.org/async-limiter" target="_blank" rel="noopener"><img src="http://img.shields.io/npm/v/async-limiter.svg?style=flat-square" alt="npm"></a>
<a href="https://travis-ci.org/STRML/async-limiter" target="_blank" rel="noopener"><img src="https://img.shields.io/travis/STRML/async-limiter.svg?style=flat-square&amp;branch=master" alt="tests"></a>
<a href="https://coveralls.io/r/STRML/async-limiter" target="_blank" rel="noopener"><img src="https://img.shields.io/coveralls/STRML/async-limiter.svg?style=flat-square&amp;branch=master" alt="coverage"></a></p>
...
<h2>Motivation</h2>
<p>Certain functions, like <code>zlib</code>, have <a href="https://github.com/nodejs/node/issues/8871#issuecomment-250915913" target="_blank" rel="noopener">undesirable behavior</a> when
...
<h2>Example</h2>
<pre class="hljs"><code><span class="hljs-keyword">var</span> Limiter = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;async-limiter&apos;</span>)
...
<h2>Zlib Example</h2>
<pre class="hljs"><code><span class="hljs-keyword">const</span> zlib = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;zlib&apos;</span>);
...
<p>Mozilla has docs on how these methods work <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array" target="_blank" rel="noopener">here</a>.</p>
<h3><code>t.push(element1, ..., elementN)</code></h3>
<h3><code>t.unshift(element1, ..., elementN)</code></h3>
<h3><code>t.splice(index , howMany[, element1[, ...[, elementN]]])</code></h3>
<h2>Properties</h2>
<h3><code>t.concurrency</code></h3>
<p>Max number of jobs the queue should process concurrently, defaults to <code>Infinity</code>.</p>
<h3><code>t.length</code></h3>
