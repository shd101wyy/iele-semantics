    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>npmlog</h1>
...
<h1>Installation</h1>
<pre class="hljs"><code>npm install npmlog --save
</code></pre>
<h1>Basic Usage</h1>
<pre class="hljs"><code><span class="hljs-keyword">var</span> log = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;npmlog&apos;</span>)

<span class="hljs-comment">// additional stuff ---------------------------+</span>
<span class="hljs-comment">// message ----------+                         |</span>
<span class="hljs-comment">// prefix ----+      |                         |</span>
<span class="hljs-comment">// level -+   |      |                         |</span>
<span class="hljs-comment">//        v   v      v                         v</span>
    log.info(<span class="hljs-string">&apos;fyi&apos;</span>, <span class="hljs-string">&apos;I have a kitty cat: %j&apos;</span>, myKittyCat)
</code></pre>
<h2>log.level</h2>
<ul>
<li>{String}</li>
...
<p>Set a template for outputting the progress bar. See the <a href="https://npmjs.com/package/gauge" target="_blank" rel="noopener">gauge documentation</a> for details.</p>
<h2>log.setGaugeThemeset(themes)</h2>
<p>Select a themeset to pick themes from for the progress bar. See the <a href="https://npmjs.com/package/gauge" target="_blank" rel="noopener">gauge documentation</a> for details.</p>
<h2>log.pause()</h2>
...
<li><a href="http://log.info" target="_blank" rel="noopener">log.info</a>(prefix, message, ...)</li>
...
<h1>Blocking TTYs</h1>
<p>We use <a href="https://npmjs.com/package/set-blocking" target="_blank" rel="noopener"><code>set-blocking</code></a> to set
