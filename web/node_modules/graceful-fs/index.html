    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>graceful-fs</h1>
...
<h2>Improvements over <a href="https://nodejs.org/api/fs.html" target="_blank" rel="noopener">fs module</a></h2>
<ul>
...
the directory.</p>
<h2>USAGE</h2>
<pre class="hljs"><code><span class="hljs-comment">// use just like fs</span>
...
<pre class="hljs"><code><span class="hljs-comment">// Make sure to read the caveat below.</span>
