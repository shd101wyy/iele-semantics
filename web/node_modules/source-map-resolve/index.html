    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Overview <a href="https://travis-ci.org/lydell/source-map-resolve" target="_blank" rel="noopener"><img src="https://travis-ci.org/lydell/source-map-resolve.svg?branch=master" alt="Build Status"></a></h1>
<p>Resolve the source map and/or sources for a generated file.</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> sourceMapResolve = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;source-map-resolve&quot;</span>)
...
<ul>
<li><a href="https://github.com/NobleJS/setImmediate" target="_blank" rel="noopener">https://github.com/NobleJS/setImmediate</a></li>
<li><a href="https://github.com/davidchambers/Base64.js" target="_blank" rel="noopener">https://github.com/davidchambers/Base64.js</a></li>
</ul>
<h1>Usage</h1>
<h3><code>sourceMapResolve.resolveSourceMap(code, codeUrl, read, callback)</code></h3>
<ul>
...
<h3><code>sourceMapResolve.resolveSources(map, mapUrl, read, [options], callback)</code></h3>
<ul>
...
<h3><code>sourceMapResolve.resolve(code, codeUrl, read, [options], callback)</code></h3>
...
<h3><code>sourceMapResolve.*Sync()</code></h3>
...
<h3><code>sourceMapResolve.parseMapToJSON(string, [data])</code></h3>
...
<h2>x-package.json5</h2>
<p>package.json, component.json and bower.json are all generated from
x-package.json5 by using <a href="https://github.com/kof/node-xpkg" target="_blank" rel="noopener"><code>xpkg</code></a>. Only edit x-package.json5, and remember to
run <code>xpkg</code> before commiting!</p>
<h2>Generating the browser version</h2>
