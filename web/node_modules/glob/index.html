    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Glob</h1>
<p>Match files using the patterns the shell uses, like stars and stuff.</p>
<p><a href="https://travis-ci.org/isaacs/node-glob/" target="_blank" rel="noopener"><img src="https://travis-ci.org/isaacs/node-glob.svg?branch=master" alt="Build Status"></a> <a href="https://ci.appveyor.com/project/isaacs/node-glob" target="_blank" rel="noopener"><img src="https://ci.appveyor.com/api/projects/status/kd7f3yftf7unxlsx?svg=true" alt="Build Status"></a> <a href="https://coveralls.io/github/isaacs/node-glob?branch=master" target="_blank" rel="noopener"><img src="https://coveralls.io/repos/isaacs/node-glob/badge.svg?branch=master&amp;service=github" alt="Coverage Status"></a></p>
...
<pre class="hljs"><code>npm i glob
</code></pre>
<pre class="hljs"><code><span class="hljs-keyword">var</span> glob = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;glob&quot;</span>)
...
<li><a href="https://github.com/isaacs/minimatch" target="_blank" rel="noopener">minimatch documentation</a></li>
</ul>
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> Glob = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;glob&quot;</span>).Glob
...
<h2>Glob Logo</h2>
<p>Glob&apos;s logo was created by <a href="http://tanyabrassie.com/" target="_blank" rel="noopener">Tanya Brassie</a>. Logo files can be found <a href="https://github.com/isaacs/node-glob/tree/master/logo" target="_blank" rel="noopener">here</a>.</p>
<p>The logo is licensed under a <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank" rel="noopener">Creative Commons Attribution-ShareAlike 4.0 International License</a>.</p>
<h2>Contributing</h2>
...
<pre class="hljs"><code># to run tests
npm test
