    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Node.js releases data</h1>
...
<p><code>data/processed</code> contains <code>envs.js</code> with both node.js and io.js data preprocessed to be used by <a href="https://github.com/ai/browserslist" target="_blank" rel="noopener">browserlist</a> and other projects. Each version in this file contains only necessary info: version, release date and optionally LTS flag.</p>
<h2>Installation</h2>
<pre class="hljs"><code>npm install --save node-releases
</code></pre>
<h2>Updating data</h2>
...
<h3>Fetching data</h3>
<pre class="hljs"><code>npm run fetch
</code></pre>
...
<pre class="hljs"><code>npm run process
</code></pre>
