    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><p><a href="https://travis-ci.org/isaacs/rimraf" target="_blank" rel="noopener"><img src="https://travis-ci.org/isaacs/rimraf.svg?branch=master" alt="Build Status"></a> <a href="https://david-dm.org/isaacs/rimraf" target="_blank" rel="noopener"><img src="https://david-dm.org/isaacs/rimraf.svg" alt="Dependency Status"></a> <a href="https://david-dm.org/isaacs/rimraf#info=devDependencies" target="_blank" rel="noopener"><img src="https://david-dm.org/isaacs/rimraf/dev-status.svg" alt="devDependency Status"></a></p>
<p>The <a href="http://en.wikipedia.org/wiki/Rm_(Unix)" target="_blank" rel="noopener">UNIX command</a> <code>rm -rf</code> for node.</p>
...
<p>For example:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> myCustomFS = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;some-custom-fs&apos;</span>)
...
<a href="http://npm.im/graceful-fs" target="_blank" rel="noopener">graceful-fs</a> in your program.</p>
<p>Only relevant for async usage.</p>
</li>
<li>
<p>glob</p>
<p>Set to <code>false</code> to disable <a href="http://npm.im/glob" target="_blank" rel="noopener">glob</a> pattern
matching.</p>
...
<a href="https://github.com/substack/node-mkdirp" target="_blank" rel="noopener">mkdirp</a>.</p>
</body></html></div>
        </main>
      </div>
    </div>
