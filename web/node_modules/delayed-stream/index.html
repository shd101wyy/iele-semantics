    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>delayed-stream</h1>
<p>Buffers events from a stream until you are ready to handle them.</p>
<h2>Installation</h2>
<pre class="hljs"><code>npm install delayed-stream
</code></pre>
<h2>Usage</h2>
<p>The following example shows how to write a http echo server that delays its
response by 1000 ms.</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> DelayedStream = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;delayed-stream&apos;</span>);
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> delayed = DelayedStream.create(req);
