    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Bootstrap version</h1>
<hr>
<p>Because there are some changes in class names and layout between Bootstrap 3 and Bootstrap 4, bootstrap-select needs to know the version of Bootstrap you are using. By default, bootstrap-select automatically detects the version of Bootstrap. However, there are some instances where the version detection does not work properly (e.g. Bootstrap is being loaded asynchronously or there is a namespace collision). For now, bootstrap-select defaults to using Bootstrap 3 formatting if version detection fails. This will be changed in the next major release.</p>
<p>You can manually specify Bootstrap&apos;s version via bootstrap-select&apos;s <code>Constructor.BootstrapVersion</code> object:</p>
<pre class="hljs"><code>$.fn.selectpicker.Constructor.BootstrapVersion = <span class="hljs-string">&apos;4&apos;</span>;
</code></pre>
<h1>Core options</h1>
<hr>
<p>Options can be passed via data attributes or JavaScript. For data attributes, append the option name to <code>data-</code>, as in
<code>data-style=&quot;&quot;</code> or <code>data-selected-text-format=&quot;count&quot;</code>.</p>
...
<hr>
<p>You can change the default settings for bootstrap-select by modifying its <code>Constructor.DEFAULTS</code> object:</p>
<pre class="hljs"><code>$.fn.selectpicker.Constructor.DEFAULTS.multipleSeparator = <span class="hljs-string">&apos; | &apos;</span>;
</code></pre>
<h1>Events</h1>
<hr>
<p>Bootstrap-select exposes a few events for hooking into select functionality.</p>
<p>hide.bs.select, hidden.bs.select, show.bs.select, and shown.bs.select all have a <code>relatedTarget</code> property, whose value is the toggling anchor element.</p>
<table class="table table-bordered table-striped">
  <thead>
    <tr>
      <th>Event Type</th>
...
<pre class="hljs"><code>$(<span class="hljs-string">&apos;#mySelect&apos;</span>).on(<span class="hljs-string">&apos;changed.bs.select&apos;</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">e, clickedIndex, isSelected, previousValue</span>) </span>{
  <span class="hljs-comment">// do something...</span>
});
</code></pre>
<h1>Sanitizer</h1>
<hr>
<p>HTML added via the <code>data-content</code> attribute on individual options is sanitized using our built-in sanitizer.</p>
<p>The default <code>whiteList</code> value is the following:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> ARIA_ATTRIBUTE_PATTERN = <span class="hljs-regexp">/^aria-[\w-]*$/i</span>;
<span class="hljs-keyword">var</span> DefaultWhitelist = {
  <span class="hljs-comment">// Global attributes allowed on any supplied element below.</span>
  <span class="hljs-string">&apos;*&apos;</span>: [<span class="hljs-string">&apos;class&apos;</span>, <span class="hljs-string">&apos;dir&apos;</span>, <span class="hljs-string">&apos;id&apos;</span>, <span class="hljs-string">&apos;lang&apos;</span>, <span class="hljs-string">&apos;role&apos;</span>, <span class="hljs-string">&apos;tabindex&apos;</span>, <span class="hljs-string">&apos;style&apos;</span>, ARIA_ATTRIBUTE_PATTERN],
  <span class="hljs-attr">a</span>: [<span class="hljs-string">&apos;target&apos;</span>, <span class="hljs-string">&apos;href&apos;</span>, <span class="hljs-string">&apos;title&apos;</span>, <span class="hljs-string">&apos;rel&apos;</span>],
  ...
  <span class="hljs-attr">img</span>: [<span class="hljs-string">&apos;src&apos;</span>, <span class="hljs-string">&apos;alt&apos;</span>, <span class="hljs-string">&apos;title&apos;</span>, <span class="hljs-string">&apos;width&apos;</span>, <span class="hljs-string">&apos;height&apos;</span>],
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> myDefaultWhiteList = $.fn.selectpicker.Constructor.DEFAULTS.whiteList;

<span class="hljs-comment">// To allow table elements</span>
myDefaultWhiteList.table = [];

<span class="hljs-comment">// To allow td elements and data-option attributes on td elements</span>
myDefaultWhiteList.td = [<span class="hljs-string">&apos;data-option&apos;</span>];

<span class="hljs-comment">// You can push your custom regex to validate your attributes.</span>
<span class="hljs-comment">// Be careful about your regular expressions being too lax</span>
<span class="hljs-keyword">var</span> myCustomRegex = <span class="hljs-regexp">/^data-my-app-[\w-]+/</span>;
myDefaultWhiteList[<span class="hljs-string">&apos;*&apos;</span>].push(myCustomRegex);
</code></pre>
<p>If you want to bypass our sanitizer because you prefer to use a dedicated library, you should do the following:</p>
<pre class="hljs"><code>$(<span class="hljs-string">&apos;#yourSelect&apos;</span>).selectpicker({
  <span class="hljs-attr">sanitizeFn</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">domNodes</span>) </span>{
    <span class="hljs-keyword">return</span> DOMPurify.sanitize(domNodes)
  }
});
</code></pre>
<p>For performance reasons, our built-in sanitizer accepts an array of DOM nodes as its first argument, rather than an HTML string. Keep that in mind if deciding to use your own <code>sanitizeFn</code>.</p>
</body></html></div>
        </main>
      </div>
    </div>
