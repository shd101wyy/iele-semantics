    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>node-error-ex <a href="https://travis-ci.org/Qix-/node-error-ex" target="_blank" rel="noopener"><img src="https://img.shields.io/travis/Qix-/node-error-ex.svg?style=flat-square" alt="Travis-CI.org Build Status"></a> <a href="https://coveralls.io/r/Qix-/node-error-ex" target="_blank" rel="noopener"><img src="https://img.shields.io/coveralls/Qix-/node-error-ex.svg?style=flat-square" alt="Coveralls.io Coverage Rating"></a></h1>
<blockquote>
<p>Easily subclass and customize new Error types</p>
</blockquote>
<h2>Examples</h2>
<p>To include in your project:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> errorEx = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;error-ex&apos;</span>);
</code></pre>
<p>To create an error message type with a specific name (note, that <code>ErrorFn.name</code>
will not reflect this):</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> JSONError = errorEx(<span class="hljs-string">&apos;JSONError&apos;</span>);
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> JSONError = errorEx(<span class="hljs-string">&apos;JSONError&apos;</span>, {<span class="hljs-attr">fileName</span>: errorEx.line(<span class="hljs-string">&apos;in %s&apos;</span>)});
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> JSONError = errorEx(<span class="hljs-string">&apos;JSONError&apos;</span>, {<span class="hljs-attr">fileName</span>: errorEx.append(<span class="hljs-string">&apos;in %s&apos;</span>)});
...
<h2>License</h2>
<p>Licensed under the <a href="http://opensource.org/licenses/MIT" target="_blank" rel="noopener">MIT License</a>.
