    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h2>Pure JS character encoding conversion <a href="https://travis-ci.org/ashtuchkin/iconv-lite" target="_blank" rel="noopener"><img src="https://travis-ci.org/ashtuchkin/iconv-lite.svg?branch=master" alt="Build Status"></a></h2>
<ul>
<li>Doesn&apos;t need native code compilation. Works on Windows and in sandboxed environments like <a href="http://c9.io" target="_blank" rel="noopener">Cloud9</a>.</li>
<li>Used in popular projects like <a href="https://github.com/expressjs/body-parser" target="_blank" rel="noopener">Express.js (body_parser)</a>,
<a href="http://gruntjs.com/" target="_blank" rel="noopener">Grunt</a>, <a href="http://www.nodemailer.com/" target="_blank" rel="noopener">Nodemailer</a>, <a href="http://yeoman.io/" target="_blank" rel="noopener">Yeoman</a> and others.</li>
<li>Faster than <a href="https://github.com/bnoordhuis/node-iconv" target="_blank" rel="noopener">node-iconv</a> (see below for performance comparison).</li>
...
<li>In-browser usage via <a href="https://github.com/substack/node-browserify" target="_blank" rel="noopener">Browserify</a> (~180k gzip compressed with Buffer shim included).</li>
<li>Typescript <a href="https://github.com/ashtuchkin/iconv-lite/blob/master/lib/index.d.ts" target="_blank" rel="noopener">type definition file</a> included.</li>
...
<p><a href="https://npmjs.org/packages/iconv-lite/" target="_blank" rel="noopener"><img src="https://nodei.co/npm/iconv-lite.png?downloads=true&amp;downloadRank=true" alt="NPM Stats"></a></p>
<h2>Usage</h2>
<h3>Basic API</h3>
<pre class="hljs"><code><span class="hljs-keyword">var</span> iconv = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;iconv-lite&apos;</span>);
...
<blockquote>
<p>NOTE: This doesn&apos;t work on latest Node versions. See <a href="https://github.com/ashtuchkin/iconv-lite/wiki/Node-v4-compatibility" target="_blank" rel="noopener">details</a>.</p>
</blockquote>
<pre class="hljs"><code><span class="hljs-comment">// After this call all Node basic primitives will understand iconv-lite encodings.</span>
...
<p>See <a href="https://github.com/ashtuchkin/iconv-lite/wiki/Supported-Encodings" target="_blank" rel="noopener">all supported encodings on wiki</a>.</p>
<p>Most singlebyte encodings are generated automatically from <a href="https://github.com/bnoordhuis/node-iconv" target="_blank" rel="noopener">node-iconv</a>. Thank you Ben Noordhuis and libiconv authors!</p>
<p>Multibyte encodings are generated from <a href="http://www.unicode.org/Public/MAPPINGS/" target="_blank" rel="noopener">Unicode.org mappings</a> and <a href="http://encoding.spec.whatwg.org/" target="_blank" rel="noopener">WHATWG Encoding Standard mappings</a>. Thank you, respective authors!</p>
...
<li>If you want to detect UTF-8 BOM when decoding other encodings, use <a href="https://github.com/danielgindi/node-autodetect-decoder-stream" target="_blank" rel="noopener">node-autodetect-decoder-stream</a> module.</li>
...
<h2>Other notes</h2>
<p>When decoding, be sure to supply a Buffer to decode() method, otherwise <a href="https://github.com/ashtuchkin/iconv-lite/wiki/Use-Buffers-when-decoding" target="_blank" rel="noopener">bad things usually happen</a>.<br>
...
<h2>Testing</h2>
<pre class="hljs"><code>$ git <span class="hljs-built_in">clone</span> git@github.com:ashtuchkin/iconv-lite.git
