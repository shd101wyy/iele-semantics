    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>node-tar</h1>
<p>Tar for Node.js.</p>
<p><a href="https://nodei.co/npm/tar/" target="_blank" rel="noopener"><img src="https://nodei.co/npm/tar.png" alt="NPM"></a></p>
<h2>API</h2>
...
<a href="https://npmjs.org/package/fstream" target="_blank" rel="noopener">fstream</a> to write files into the
...
<pre class="hljs"><code>{
  <span class="hljs-attr">path</span>: <span class="hljs-string">&apos;/path/to/extract/tar/into&apos;</span>,
  <span class="hljs-attr">strip</span>: <span class="hljs-number">0</span>, <span class="hljs-comment">// how many path segments to strip from the root when extracting</span>
}
</code></pre>
