    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>duplexer2 <a href="https://travis-ci.org/deoxxa/duplexer2" target="_blank" rel="noopener"><img src="https://travis-ci.org/deoxxa/duplexer2.svg?branch=master" alt="Build Status"></a> <a href="https://coveralls.io/github/deoxxa/duplexer2?branch=master" target="_blank" rel="noopener"><img src="https://coveralls.io/repos/deoxxa/duplexer2/badge.svg?branch=master&amp;service=github" alt="Coverage Status"></a></h1>
<p>Like <a href="https://github.com/Raynos/duplexer" target="_blank" rel="noopener">duplexer</a> but using Streams3</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> stream = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;stream&quot;</span>);
...
<pre class="hljs"><code>got data &quot;oh, hi there&quot;
finished writing
got finish event
finished ending
got end event
...
<h2>Overview</h2>
<p>This is a reimplementation of <a href="https://www.npmjs.com/package/duplexer" target="_blank" rel="noopener">duplexer</a> using the
Streams3 API which is standard in Node as of v4. Everything largely
works the same.</p>
<h2>Installation</h2>
<p><a href="https://docs.npmjs.com/cli/install" target="_blank" rel="noopener">Available via <code>npm</code></a>:</p>
<pre class="hljs"><code>$ npm i duplexer2
</code></pre>
<h2>API</h2>
<h3>duplexer2</h3>
...
<pre class="hljs"><code>duplexer2([options], writable, readable)
</code></pre>
<pre class="hljs"><code><span class="hljs-keyword">const</span> duplex = duplexer2(<span class="hljs-keyword">new</span> stream.Writable(), <span class="hljs-keyword">new</span> stream.Readable());
</code></pre>
<p>Arguments</p>
<ul>
...
<h2>Contact</h2>
<ul>
<li>GitHub (<a href="http://github.com/deoxxa" target="_blank" rel="noopener">deoxxa</a>)</li>
<li>Twitter (<a href="http://twitter.com/deoxxa" target="_blank" rel="noopener">@deoxxa</a>)</li>
<li>Email (<a href="mailto:deoxxa@fknsrs.biz" target="_blank" rel="noopener">deoxxa@fknsrs.biz</a>)</li>
</ul>
</body></html></div>
        </main>
      </div>
