    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>node-http-signature</h1>
...
<p>MIT.</p>
<h2>Bugs</h2>
<p>See <a href="https://github.com/joyent/node-http-signature/issues" target="_blank" rel="noopener">https://github.com/joyent/node-http-signature/issues</a>.</p>
</body></html></div>
        </main>
      </div>
    </div>
