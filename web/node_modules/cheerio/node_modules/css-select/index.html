...
<p>In its default configuration, css-select queries the DOM structure of the <a href="https://github.com/fb55/domhandler" target="_blank" rel="noopener"><code>domhandler</code></a> module (also known as htmlparser2 DOM).</p>
...
<h2>API</h2>
<pre class="hljs"><code><span class="hljs-keyword">var</span> CSSselect = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;css-select&quot;</span>);
</code></pre>
