    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>node-url</h1>
<p><a href="https://travis-ci.org/defunctzombie/node-url" target="_blank" rel="noopener"><img src="https://travis-ci.org/defunctzombie/node-url.svg?branch=master" alt="Build Status"></a></p>
<p>This module has utilities for URL resolution and parsing meant to have feature parity with node.js core <a href="http://nodejs.org/api/url.html" target="_blank" rel="noopener">url</a> module.</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> url = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;url&apos;</span>);
</code></pre>
<h2>api</h2>
