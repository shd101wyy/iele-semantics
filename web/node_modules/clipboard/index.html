    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>clipboard.js</h1>
<p><a href="https://travis-ci.org/zenorocha/clipboard.js" target="_blank" rel="noopener"><img src="http://img.shields.io/travis/zenorocha/clipboard.js/master.svg?style=flat" alt="Build Status"></a>
...
<pre class="hljs"><code>npm install clipboard --save
</code></pre>
...
<pre class="hljs"><code><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;dist/clipboard.min.js&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
...
<pre class="hljs"><code><span class="hljs-keyword">new</span> ClipboardJS(<span class="hljs-string">&apos;.btn&apos;</span>);
</code></pre>
...
<pre class="hljs"><code><span class="hljs-comment">&lt;!-- Target --&gt;</span>
...
<pre class="hljs"><code><span class="hljs-comment">&lt;!-- Trigger --&gt;</span>
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> clipboard = <span class="hljs-keyword">new</span> ClipboardJS(<span class="hljs-string">&apos;.btn&apos;</span>);
...
<p>The tooltips you see on the <a href="https://clipboardjs.com/" target="_blank" rel="noopener">demo site</a> were built using <a href="https://github.com/primer/primer-css/tree/master/modules/primer-tooltips" target="_blank" rel="noopener">GitHub&apos;s Primer</a>. You may want to check that out if you&apos;re looking for a similar look and feel.</p>
...
<p>This library relies on both <a href="https://developer.mozilla.org/en-US/docs/Web/API/Selection" target="_blank" rel="noopener">Selection</a> and <a href="https://developer.mozilla.org/en-US/docs/Web/API/Document/execCommand" target="_blank" rel="noopener">execCommand</a> APIs. The first one is <a href="http://caniuse.com/#search=selection" target="_blank" rel="noopener">supported by all browsers</a> while the second one is supported in the following browsers.</p>
<table>
<thead>
<tr>
