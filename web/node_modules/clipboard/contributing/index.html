    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Contributing guide</h1>
...
<ul>
<li>
<p>Reporting bugs: describe the bug as clearly as you can, including steps to reproduce, what happened and what you were expecting to happen. Also include browser version, OS and other related software&apos;s (npm, Node.js, etc) versions when applicable.</p>
</li>
<li>
<p>Proposing features: explain the proposed feature, what it should do, why it is useful, how users should use it. Give us as much info as possible so it will be easier to discuss, access and implement the proposed feature. When you&apos;re unsure about a certain aspect of the feature, feel free to leave it open for others to discuss and find an appropriate solution.</p>
</li>
</ul>
<h2>Proposing pull requests</h2>
...
<a href="https://github.com/npm/npm/issues/9204" target="_blank" rel="noopener">https://github.com/npm/npm/issues/9204</a></p>
</body></html></div>
        </main>
      </div>
    </div>
