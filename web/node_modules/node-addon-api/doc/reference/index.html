    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Reference (template)</h1>
<p>Holds a counted reference to a <a href="value/"><code>Napi::Value</code></a> object; initially a weak reference unless otherwise specified, may be changed to/from a strong reference by adjusting the refcount.</p>
...
<ul>
<li><a href="object_wrap/"><code>Napi::ObjectWrap</code></a></li>
<li><a href="object_reference/"><code>Napi::ObjectReference</code></a></li>
<li><a href="function_reference/"><code>Napi::FunctionReference</code></a></li>
</ul>
<h2>Methods</h2>
<h3>Factory Method</h3>
<pre class="hljs"><code><span class="hljs-keyword">static</span> Napi::Reference&lt;T&gt; Napi::Reference::New(<span class="hljs-keyword">const</span> T&amp; value, <span class="hljs-keyword">uint32_t</span> initialRefcount = <span class="hljs-number">0</span>);
</code></pre>
<ul>
<li>
...
<pre class="hljs"><code>Napi::Reference::Reference();
</code></pre>
<p>Creates a new <em>empty</em> <code>Napi::Reference</code> instance.</p>
<h3>Constructor</h3>
<pre class="hljs"><code>Napi::Reference::Reference(napi_env env, napi_value value);
</code></pre>
<ul>
<li>
...
<h3>Env</h3>
<pre class="hljs"><code>Napi::Env Napi::Reference::Env() <span class="hljs-keyword">const</span>;
</code></pre>
<p>Returns the <code>Napi::Env</code> value in which the <code>Napi::Reference</code> was instantiated.</p>
<h3>IsEmpty</h3>
<pre class="hljs"><code><span class="hljs-keyword">bool</span> Napi::Reference::IsEmpty() <span class="hljs-keyword">const</span>;
</code></pre>
<p>Determines whether the value held by the <code>Napi::Reference</code> is empty.</p>
<h3>Value</h3>
<pre class="hljs"><code>T Napi::Reference::Value() <span class="hljs-keyword">const</span>;
</code></pre>
<p>Returns the value held by the <code>Napi::Reference</code>.</p>
<h3>Ref</h3>
<pre class="hljs"><code><span class="hljs-keyword">uint32_t</span> Napi::Reference::Ref();
</code></pre>
...
<h3>Unref</h3>
<pre class="hljs"><code><span class="hljs-keyword">uint32_t</span> Napi::Reference::Unref();
</code></pre>
...
<h3>Reset (Empty)</h3>
<pre class="hljs"><code><span class="hljs-keyword">void</span> Napi::Reference::Reset();
</code></pre>
<p>Sets the value held by the <code>Napi::Reference</code> to be empty.</p>
<h3>Reset</h3>
<pre class="hljs"><code><span class="hljs-keyword">void</span> Napi::Reference::Reset(<span class="hljs-keyword">const</span> T&amp; value, <span class="hljs-keyword">uint32_t</span> refcount = <span class="hljs-number">0</span>);
</code></pre>
<ul>
<li>
<p><code>[in] value</code>: The value which is to be referenced.</p>
...
<pre class="hljs"><code><span class="hljs-keyword">void</span> Napi::Reference::SuppressDestruct();
</code></pre>
