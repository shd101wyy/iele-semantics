    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>EscapableHandleScope</h1>
...
<a href="object_lifetime_management/">Object lifetime management</a>.</p>
<h2>Methods</h2>
<h3>Constructor</h3>
<p>Creates a new escapable handle scope.</p>
<pre class="hljs"><code>Napi::EscapableHandleScope Napi::EscapableHandleScope::New(Napi:Env env);
</code></pre>
<ul>
...
<h3>Constructor</h3>
<p>Creates a new escapable handle scope.</p>
<pre class="hljs"><code>Napi::EscapableHandleScope Napi::EscapableHandleScope::New(napi_env env, napi_handle_scope scope);
</code></pre>
<ul>
...
<pre class="hljs"><code><span class="hljs-keyword">operator</span> Napi::EscapableHandleScope::napi_escapable_handle_scope() <span class="hljs-keyword">const</span>
</code></pre>
...
<h3>Destructor</h3>
<pre class="hljs"><code>Napi::EscapableHandleScope::~EscapableHandleScope();
</code></pre>
...
<h3>Escape</h3>
<pre class="hljs"><code>napi::Value Napi::EscapableHandleScope::Escape(napi_value escapee);
</code></pre>
<ul>
...
<h3>Env</h3>
<pre class="hljs"><code>Napi::Env Napi::EscapableHandleScope::Env() <span class="hljs-keyword">const</span>;
</code></pre>
