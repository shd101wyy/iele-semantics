    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Env</h1>
...
<h2>Methods</h2>
<h3>Constructor</h3>
<pre class="hljs"><code>Napi::Env::Env(napi_env env);
</code></pre>
<ul>
<li><code>[in] env</code>: The <code>napi_env</code> environment from which to construct the <code>Napi::Env</code> object.</li>
</ul>
<h3>napi_env</h3>
<pre class="hljs"><code><span class="hljs-function"><span class="hljs-keyword">operator</span> <span class="hljs-title">napi_env</span><span class="hljs-params">()</span> <span class="hljs-keyword">const</span></span>;
</code></pre>
<p>Returns the <code>napi_env</code> opaque data structure representing the environment.</p>
<h3>Global</h3>
<pre class="hljs"><code>Napi::Object Napi::Env::Global() <span class="hljs-keyword">const</span>;
</code></pre>
<p>Returns the <code>Napi::Object</code> representing the environment&apos;s JavaScript Global Object.</p>
<h3>Undefined</h3>
<pre class="hljs"><code>Napi::Value Napi::Env::Undefined() <span class="hljs-keyword">const</span>;
</code></pre>
<p>Returns the <code>Napi::Value</code> representing the environment&apos;s JavaScript Undefined Object.</p>
<h3>Null</h3>
<pre class="hljs"><code>Napi::Value Napi::Env::Null() <span class="hljs-keyword">const</span>;
</code></pre>
<p>Returns the <code>Napi::Value</code> representing the environment&apos;s JavaScript Null Object.</p>
<h3>IsExceptionPending</h3>
<pre class="hljs"><code><span class="hljs-keyword">bool</span> Napi::Env::IsExceptionPending() <span class="hljs-keyword">const</span>;
</code></pre>
<p>Returns a <code>bool</code> indicating if an exception is pending in the environment.</p>
<h3>GetAndClearPendingException</h3>
<pre class="hljs"><code>Napi::Error Napi::Env::GetAndClearPendingException();
</code></pre>
