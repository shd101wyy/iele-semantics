    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>MemoryManagement</h1>
<p>The <code>Napi::MemoryManagement</code> class contains functions that give the JavaScript engine
an indication of the amount of externally allocated memory that is kept alive by
JavaScript objects.</p>
<h2>Methods</h2>
<h3>AdjustExternalMemory</h3>
<p>The function <code>AdjustExternalMemory</code> adjusts the amount of registered external
...
<pre class="hljs"><code><span class="hljs-keyword">static</span> <span class="hljs-keyword">int64_t</span> Napi::MemoryManagement::AdjustExternalMemory(Napi::Env env, <span class="hljs-keyword">int64_t</span> change_in_bytes);
</code></pre>
<ul>
...
alive by JavaScript objects expressed in bytes.</li>
</ul>
