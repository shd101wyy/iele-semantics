    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>sshpk</h1>
...
<a href="https://github.com/joyent/node-http-signature" target="_blank" rel="noopener"><code>node-http-signature</code></a>
(work by <a href="https://github.com/mcavage" target="_blank" rel="noopener">Mark Cavage</a> and
<a href="https://github.com/bahamas10" target="_blank" rel="noopener">Dave Eddy</a>) and
<a href="https://github.com/bahamas10/node-ssh-fingerprint" target="_blank" rel="noopener"><code>node-ssh-fingerprint</code></a>
(work by Dave Eddy), with additions (including ECDSA support) by
<a href="https://github.com/arekinath" target="_blank" rel="noopener">Alex Wilson</a>.</p>
<h2>Install</h2>
<pre class="hljs"><code>npm install sshpk
</code></pre>
<h2>Examples</h2>
<pre class="hljs"><code><span class="hljs-keyword">var</span> sshpk = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;sshpk&apos;</span>);
...
<pre class="hljs"><code><span class="hljs-comment">/* Read in a PEM public key */</span>
...
<pre class="hljs"><code><span class="hljs-comment">/* Read in an OpenSSH/PEM *private* key */</span>
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> fp = sshpk.parseFingerprint(<span class="hljs-string">&apos;SHA256:PYC9kPVC6J873CSIbfp0LwYeczP/W4ffObNCuDJ1u5w&apos;</span>);
...
<h3><code>Key#fingerprint([algorithm = &apos;sha256&apos;[, hashType = &apos;ssh&apos;]])</code></h3>
...
<h2>Fingerprints</h2>
<h3><code>parseFingerprint(fingerprint[, options])</code></h3>
...
<h3><code>Fingerprint#matches(keyOrCertificate)</code></h3>
...
<h3><code>Certificate#getExtension(nameOrOid)</code></h3>
...
<h3><code>Certificate#getExtensions()</code></h3>
...
<p>Returns an Identity instance.</p>
<h3><code>identityFromArray(arr)</code></h3>
...
<h3><code>Identity#get(name[, asArray])</code></h3>
...
<h3><code>Identity#toArray()</code></h3>
...
<ul>
<li><a href="https://github.com/arekinath/node-sshpk-agent" target="_blank" rel="noopener"><code>sshpk-agent</code></a> is a library
