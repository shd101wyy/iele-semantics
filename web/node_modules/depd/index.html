    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>depd</h1>
<p><a href="https://npmjs.org/package/depd" target="_blank" rel="noopener"><img src="https://img.shields.io/npm/v/depd.svg" alt="NPM Version"></a>
<a href="https://npmjs.org/package/depd" target="_blank" rel="noopener"><img src="https://img.shields.io/npm/dm/depd.svg" alt="NPM Downloads"></a>
<a href="https://nodejs.org/en/download/" target="_blank" rel="noopener"><img src="https://img.shields.io/node/v/depd.svg" alt="Node.js Version"></a>
<a href="https://travis-ci.org/dougwilson/nodejs-depd" target="_blank" rel="noopener"><img src="https://img.shields.io/travis/dougwilson/nodejs-depd/master.svg?label=linux" alt="Linux Build"></a>
<a href="https://ci.appveyor.com/project/dougwilson/nodejs-depd" target="_blank" rel="noopener"><img src="https://img.shields.io/appveyor/ci/dougwilson/nodejs-depd/master.svg?label=windows" alt="Windows Build"></a>
<a href="https://coveralls.io/r/dougwilson/nodejs-depd?branch=master" target="_blank" rel="noopener"><img src="https://img.shields.io/coveralls/dougwilson/nodejs-depd/master.svg" alt="Coverage Status"></a></p>
...
<pre class="hljs"><code>$ npm install depd
</code></pre>
<p>This module can also be bundled with systems like
<a href="http://browserify.org/" target="_blank" rel="noopener">Browserify</a> or <a href="https://webpack.github.io/" target="_blank" rel="noopener">webpack</a>,
though by default this module will alter it&apos;s API to no longer display or
track deprecations.</p>
<h2>API</h2>
<!-- eslint-disable no-unused-vars -->
<pre class="hljs"><code><span class="hljs-keyword">var</span> deprecate = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;depd&apos;</span>)(<span class="hljs-string">&apos;my-module&apos;</span>)
</code></pre>
...
<pre class="hljs"><code>DeprecationError: my-cool-module deprecated oldfunction
...
<pre class="hljs"><code>$ NO_DEPRECATION=my-module,othermod node app.js
</code></pre>
...
<pre class="hljs"><code>$ TRACE_DEPRECATION=my-module,othermod node app.js
</code></pre>
...
<pre class="hljs"><code>bright cyan    bright yellow
|              |          reset       cyan
|              |          |           |
&#x25BC;              &#x25BC;          &#x25BC;           &#x25BC;
...
<pre class="hljs"><code>Sun, 15 Jun 2014 05:21:37 GMT my-cool-module deprecated oldfunction at [eval]-wrapper:6:22
&#x25B2;                             &#x25B2;              &#x25B2;          &#x25B2;              &#x25B2;
|                             |              |          |              |
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> deprecate = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;depd&apos;</span>)(<span class="hljs-string">&apos;my-cool-module&apos;</span>)
...
<span class="hljs-built_in">exports</span>.oldfunction = deprecate.function(<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">oldfunction</span> (<span class="hljs-params"></span>) </span>{
  <span class="hljs-comment">// all calls to function are deprecated</span>
})

<span class="hljs-comment">// specific message</span>
<span class="hljs-built_in">exports</span>.oldfunction = deprecate.function(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
  <span class="hljs-comment">// all calls to function are deprecated</span>
...
<span class="hljs-built_in">exports</span>.weirdfunction = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
...
<span class="hljs-built_in">exports</span>.oldprop = <span class="hljs-string">&apos;something&apos;</span>

<span class="hljs-comment">// message automatically derives from property name</span>
deprecate.property(<span class="hljs-built_in">exports</span>, <span class="hljs-string">&apos;oldprop&apos;</span>)

<span class="hljs-comment">// explicit message</span>
deprecate.property(<span class="hljs-built_in">exports</span>, <span class="hljs-string">&apos;oldprop&apos;</span>, <span class="hljs-string">&apos;oldprop &gt;= 0.10&apos;</span>)
</code></pre>
<h2>License</h2>
