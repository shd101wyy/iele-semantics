    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>minimatch</h1>
<p>A minimal matching utility.</p>
<p><a href="http://travis-ci.org/isaacs/minimatch" target="_blank" rel="noopener"><img src="https://secure.travis-ci.org/isaacs/minimatch.svg" alt="Build Status"></a></p>
...
objects.</p>
<h2>Usage</h2>
<pre class="hljs"><code><span class="hljs-keyword">var</span> minimatch = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;minimatch&quot;</span>)
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> Minimatch = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;minimatch&quot;</span>).Minimatch
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> isJS = minimatch(file, <span class="hljs-string">&quot;*.js&quot;</span>, { <span class="hljs-attr">matchBase</span>: <span class="hljs-literal">true</span> })
</code></pre>
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> javascripts = fileList.filter(minimatch.filter(<span class="hljs-string">&quot;*.js&quot;</span>, {<span class="hljs-attr">matchBase</span>: <span class="hljs-literal">true</span>}))
</code></pre>
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> javascripts = minimatch.match(fileList, <span class="hljs-string">&quot;*.js&quot;</span>, {<span class="hljs-attr">matchBase</span>: <span class="hljs-literal">true</span>}))
</code></pre>
