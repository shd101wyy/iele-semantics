    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>caller-path <a href="https://travis-ci.org/sindresorhus/caller-path" target="_blank" rel="noopener"><img src="https://travis-ci.org/sindresorhus/caller-path.svg?branch=master" alt="Build Status"></a></h1>
<blockquote>
<p>Get the path of the caller function</p>
</blockquote>
<h2>Install</h2>
<pre class="hljs"><code>$ npm install --save caller-path
</code></pre>
<h2>Usage</h2>
