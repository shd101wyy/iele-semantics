    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>combined-stream</h1>
...
<ul>
<li>
<p><a href="https://www.npmjs.com/package/combined-stream2" target="_blank" rel="noopener">combined-stream2</a>: A drop-in streams2-compatible replacement for the combined-stream module.</p>
</li>
<li>
<p><a href="https://www.npmjs.com/package/multistream" target="_blank" rel="noopener">multistream</a>: A stream that emits multiple other streams one after another.</p>
</li>
</ul>
<h2>Installation</h2>
<pre class="hljs"><code>npm install combined-stream
</code></pre>
<h2>Usage</h2>
<p>Here is a simple example that shows how you can use combined-stream to combine
two files into one:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> CombinedStream = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;combined-stream&apos;</span>);
