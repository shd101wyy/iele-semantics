    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Porting to the Buffer.from/Buffer.alloc API</h1>
<p><a id="overview"></a></p>
<h2>Overview</h2>
<ul>
...
<pre class="hljs"><code><span class="hljs-meta">$</span><span class="bash"> <span class="hljs-built_in">export</span> NODE_OPTIONS=<span class="hljs-string">&apos;--trace-warnings --pending-deprecation&apos;</span></span>
...
<p>Eslint rules <a href="https://eslint.org/docs/rules/no-buffer-constructor" target="_blank" rel="noopener">no-buffer-constructor</a>
or
<a href="https://github.com/mysticatea/eslint-plugin-node/blob/master/docs/rules/no-deprecated-api.md" target="_blank" rel="noopener">node/no-deprecated-api</a>
...
<a href="https://github.com/chalker/safer-buffer#why-not-safe-buffer" target="_blank" rel="noopener">work correctly</a> when <code>Buffer</code> is
...
<p>Enabling eslint rule <a href="https://eslint.org/docs/rules/no-buffer-constructor" target="_blank" rel="noopener">no-buffer-constructor</a>
or
<a href="https://github.com/mysticatea/eslint-plugin-node/blob/master/docs/rules/no-deprecated-api.md" target="_blank" rel="noopener">node/no-deprecated-api</a>
is recommended to avoid accidential unsafe Buffer API usage.</p>
<p>There is also a <a href="https://github.com/joyeecheung/node-dep-codemod#dep005" target="_blank" rel="noopener">JSCodeshift codemod</a>
...
<p>Utilize <a href="https://www.npmjs.com/package/safer-buffer" target="_blank" rel="noopener">safer-buffer</a> as a polyfill to support older
Node.js versions.</p>
...
<p>Alternatively, you could use <a href="https://www.npmjs.com/package/buffer-from" target="_blank" rel="noopener">buffer-from</a> and/or
<a href="https://www.npmjs.com/package/buffer-alloc" target="_blank" rel="noopener">buffer-alloc</a> <a href="https://ponyfill.com/" target="_blank" rel="noopener">ponyfills</a> &#x2014;
...
<p><em>Alternatively, you could use <a href="https://www.npmjs.com/package/safe-buffer" target="_blank" rel="noopener">safe-buffer</a> &#x2014; it also
provides a polyfill, but takes a different approach which has
<a href="https://github.com/chalker/safer-buffer#why-not-safe-buffer" target="_blank" rel="noopener">it&apos;s drawbacks</a>. It will allow you
...
<p>Before:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> buf = <span class="hljs-keyword">new</span> Buffer(notNumber, encoding);
</code></pre>
<p>After:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> buf;
...
<pre class="hljs"><code><span class="hljs-keyword">const</span> buf = Buffer.alloc ? Buffer.alloc(number) : <span class="hljs-keyword">new</span> Buffer(number).fill(<span class="hljs-number">0</span>);
</code></pre>
...
<pre class="hljs"><code>function stringToBase64(req, res) {
