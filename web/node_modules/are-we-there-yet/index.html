    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h2>are-we-there-yet</h2>
...
<h1>Usage</h1>
<pre class="hljs"><code><span class="hljs-keyword">var</span> TrackerGroup = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;are-we-there-yet&quot;</span>).TrackerGroup
...
<pre class="hljs"><code>function (name, completed, tracker)
</code></pre>
...
<pre class="hljs"><code>  <span class="hljs-keyword">var</span> subGroup = tracker.addUnit(<span class="hljs-keyword">new</span> TrackerGroup(name), weight)
</code></pre>
<ul>
<li>var subItem = tracker.newItem(<strong>name</strong>, <strong>todo</strong>, <strong>weight</strong>)</li>
</ul>
<p>The above is exactly equivalent to:</p>
<pre class="hljs"><code>  <span class="hljs-keyword">var</span> subItem = tracker.addUnit(<span class="hljs-keyword">new</span> Tracker(name, todo), weight)
</code></pre>
<ul>
<li>var subStream = tracker.newStream(<strong>name</strong>, <strong>todo</strong>, <strong>weight</strong>)</li>
</ul>
<p>The above is exactly equivalent to:</p>
<pre class="hljs"><code>  <span class="hljs-keyword">var</span> subStream = tracker.addUnit(<span class="hljs-keyword">new</span> TrackerStream(name, todo), weight)
</code></pre>
<ul>
