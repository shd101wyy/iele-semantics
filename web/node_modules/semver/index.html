    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>semver(1) -- The semantic versioner for npm</h1>
<h2>Install</h2>
<pre class="hljs"><code>npm install --save semver
</code></pre>
<h2>Usage</h2>
<p>As a node module:</p>
<pre class="hljs"><code><span class="hljs-keyword">const</span> semver = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;semver&apos;</span>)
...
<a href="https://semver.org/" target="_blank" rel="noopener">https://semver.org/</a>.</p>
...
object to any
<a href="https://github.com/npm/node-semver#functions" target="_blank" rel="noopener">functions</a> that do
range matching.</p>
...
<pre class="hljs"><code>semver.inc(<span class="hljs-string">&apos;1.2.3&apos;</span>, <span class="hljs-string">&apos;prerelease&apos;</span>, <span class="hljs-string">&apos;beta&apos;</span>)
<span class="hljs-comment">// &apos;1.2.4-beta.0&apos;</span>
</code></pre>
<p>command-line example:</p>
<pre class="hljs"><code>$ semver 1.2.3 -i prerelease --preid beta
1.2.4-beta.0
</code></pre>
<p>Which then can be used to increment further:</p>
<pre class="hljs"><code>$ semver 1.2.4-beta.0 -i prerelease
1.2.4-beta.1
</code></pre>
...
<pre class="hljs"><code>range-set  ::= range ( logical-or range ) *
...
<li><code>includePrerelease</code>  Set to suppress the <a href="https://github.com/npm/node-semver#prerelease-tags" target="_blank" rel="noopener">default
behavior</a> of
