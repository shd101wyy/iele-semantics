    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h2>getpass</h2>
...
<pre class="hljs"><code>npm install --save getpass
</code></pre>
<pre class="hljs"><code><span class="hljs-keyword">const</span> mod_getpass = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;getpass&apos;</span>);
</code></pre>
<h2>API</h2>
