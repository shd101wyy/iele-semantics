...
<a href="http://semver.org/" target="_blank" rel="noopener">http://semver.org/</a>.</p>
...
<pre class="hljs"><code><span class="hljs-meta">$</span><span class="bash"> semver 1.2.3 -i prerelease --preid beta</span>
1.2.4-beta.0
</code></pre>
<p>Which then can be used to increment further:</p>
<pre class="hljs"><code><span class="hljs-meta">$</span><span class="bash"> semver 1.2.4-beta.0 -i prerelease</span>
1.2.4-beta.1
</code></pre>
