    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>qs <sup><a href="https://npmjs.org/package/qs" target="_blank" rel="noopener"><img src="http://versionbadg.es/ljharb/qs.svg" alt="Version Badge"></a></sup></h1>
<p><a href="https://travis-ci.org/ljharb/qs" target="_blank" rel="noopener"><img src="https://api.travis-ci.org/ljharb/qs.svg" alt="Build Status"></a>
<a href="https://david-dm.org/ljharb/qs" target="_blank" rel="noopener"><img src="https://david-dm.org/ljharb/qs.svg" alt="dependency status"></a>
<a href="https://david-dm.org/ljharb/qs?type=dev" target="_blank" rel="noopener"><img src="https://david-dm.org/ljharb/qs/dev-status.svg" alt="dev dependency status"></a>
<a href="LICENSE"><img src="http://img.shields.io/npm/l/qs.svg" alt="License"></a>
<a href="http://npm-stat.com/charts.html?package=qs" target="_blank" rel="noopener"><img src="http://img.shields.io/npm/dm/qs.svg" alt="Downloads"></a></p>
<p><a href="https://npmjs.org/package/qs" target="_blank" rel="noopener"><img src="https://nodei.co/npm/qs.png?downloads=true&amp;stars=true" alt="npm badge"></a></p>
<p>A querystring parsing and stringifying library with some added security.</p>
<p>Lead Maintainer: <a href="https://github.com/ljharb" target="_blank" rel="noopener">Jordan Harband</a></p>
<p>The <strong>qs</strong> module was originally created and maintained by <a href="https://github.com/visionmedia/node-querystring" target="_blank" rel="noopener">TJ Holowaychuk</a>.</p>
<h2>Usage</h2>
...
<pre class="hljs"><code>qs.parse(string, [options]);
</code></pre>
...
<pre class="hljs"><code>assert.deepEqual(qs.parse(<span class="hljs-string">&apos;foo[bar]=baz&apos;</span>), {
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> nullObject = qs.parse(<span class="hljs-string">&apos;a[hasOwnProperty]=b&apos;</span>, { <span class="hljs-attr">plainObjects</span>: <span class="hljs-literal">true</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> protoObject = qs.parse(<span class="hljs-string">&apos;a[hasOwnProperty]=b&apos;</span>, { <span class="hljs-attr">allowPrototypes</span>: <span class="hljs-literal">true</span> });
...
<pre class="hljs"><code>assert.deepEqual(qs.parse(<span class="hljs-string">&apos;a%5Bb%5D=c&apos;</span>), {
...
<pre class="hljs"><code>assert.deepEqual(qs.parse(<span class="hljs-string">&apos;foo[bar][baz]=foobarbaz&apos;</span>), {
    <span class="hljs-attr">foo</span>: {
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> expected = {
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> deep = qs.parse(<span class="hljs-string">&apos;a[b][c][d][e][f][g][h][i]=j&apos;</span>, { <span class="hljs-attr">depth</span>: <span class="hljs-number">1</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> limited = qs.parse(<span class="hljs-string">&apos;a=b&amp;c=d&apos;</span>, { <span class="hljs-attr">parameterLimit</span>: <span class="hljs-number">1</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> prefixed = qs.parse(<span class="hljs-string">&apos;?a=b&amp;c=d&apos;</span>, { <span class="hljs-attr">ignoreQueryPrefix</span>: <span class="hljs-literal">true</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> delimited = qs.parse(<span class="hljs-string">&apos;a=b;c=d&apos;</span>, { <span class="hljs-attr">delimiter</span>: <span class="hljs-string">&apos;;&apos;</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> regexed = qs.parse(<span class="hljs-string">&apos;a=b;c=d,e=f&apos;</span>, { <span class="hljs-attr">delimiter</span>: <span class="hljs-regexp">/[;,]/</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> withDots = qs.parse(<span class="hljs-string">&apos;a.b=c&apos;</span>, { <span class="hljs-attr">allowDots</span>: <span class="hljs-literal">true</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> withArray = qs.parse(<span class="hljs-string">&apos;a[]=b&amp;a[]=c&apos;</span>);
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> withIndexes = qs.parse(<span class="hljs-string">&apos;a[1]=c&amp;a[0]=b&apos;</span>);
...
their order:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> noSparse = qs.parse(<span class="hljs-string">&apos;a[1]=b&amp;a[15]=c&apos;</span>);
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> withEmptyString = qs.parse(<span class="hljs-string">&apos;a[]=&amp;a[]=b&apos;</span>);
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> withMaxIndex = qs.parse(<span class="hljs-string">&apos;a[100]=b&apos;</span>);
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> withArrayLimit = qs.parse(<span class="hljs-string">&apos;a[1]=b&apos;</span>, { <span class="hljs-attr">arrayLimit</span>: <span class="hljs-number">0</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> noParsingArrays = qs.parse(<span class="hljs-string">&apos;a[]=b&apos;</span>, { <span class="hljs-attr">parseArrays</span>: <span class="hljs-literal">false</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> mixedNotation = qs.parse(<span class="hljs-string">&apos;a[0]=b&amp;a[b]=c&apos;</span>);
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> arraysOfObjects = qs.parse(<span class="hljs-string">&apos;a[][b]=c&apos;</span>);
assert.deepEqual(arraysOfObjects, { <span class="hljs-attr">a</span>: [{ <span class="hljs-attr">b</span>: <span class="hljs-string">&apos;c&apos;</span> }] });
</code></pre>
<h3>Stringifying</h3>
<p><a href="#preventEval"></a></p>
<pre class="hljs"><code>qs.stringify(object, [options]);
</code></pre>
<p>When stringifying, <strong>qs</strong> by default URI encodes output. Objects are stringified as you would expect:</p>
<pre class="hljs"><code>assert.equal(qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-string">&apos;b&apos;</span> }), <span class="hljs-string">&apos;a=b&apos;</span>);
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> unencoded = qs.stringify({ <span class="hljs-attr">a</span>: { <span class="hljs-attr">b</span>: <span class="hljs-string">&apos;c&apos;</span> } }, { <span class="hljs-attr">encode</span>: <span class="hljs-literal">false</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> encodedValues = qs.stringify(
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> encoded = qs.stringify({ <span class="hljs-attr">a</span>: { <span class="hljs-attr">b</span>: <span class="hljs-string">&apos;c&apos;</span> } }, { <span class="hljs-attr">encoder</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">str</span>) </span>{
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> decoded = qs.parse(<span class="hljs-string">&apos;x=z&apos;</span>, { <span class="hljs-attr">decoder</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">str</span>) </span>{
...
<pre class="hljs"><code>qs.stringify({ <span class="hljs-attr">a</span>: [<span class="hljs-string">&apos;b&apos;</span>, <span class="hljs-string">&apos;c&apos;</span>, <span class="hljs-string">&apos;d&apos;</span>] });
...
<pre class="hljs"><code>qs.stringify({ <span class="hljs-attr">a</span>: [<span class="hljs-string">&apos;b&apos;</span>, <span class="hljs-string">&apos;c&apos;</span>, <span class="hljs-string">&apos;d&apos;</span>] }, { <span class="hljs-attr">indices</span>: <span class="hljs-literal">false</span> });
...
<pre class="hljs"><code>qs.stringify({ <span class="hljs-attr">a</span>: [<span class="hljs-string">&apos;b&apos;</span>, <span class="hljs-string">&apos;c&apos;</span>] }, { <span class="hljs-attr">arrayFormat</span>: <span class="hljs-string">&apos;indices&apos;</span> })
...
<pre class="hljs"><code>qs.stringify({ <span class="hljs-attr">a</span>: { <span class="hljs-attr">b</span>: { <span class="hljs-attr">c</span>: <span class="hljs-string">&apos;d&apos;</span>, <span class="hljs-attr">e</span>: <span class="hljs-string">&apos;f&apos;</span> } } });
...
<pre class="hljs"><code>qs.stringify({ <span class="hljs-attr">a</span>: { <span class="hljs-attr">b</span>: { <span class="hljs-attr">c</span>: <span class="hljs-string">&apos;d&apos;</span>, <span class="hljs-attr">e</span>: <span class="hljs-string">&apos;f&apos;</span> } } }, { <span class="hljs-attr">allowDots</span>: <span class="hljs-literal">true</span> });
<span class="hljs-comment">// &apos;a.b.c=d&amp;a.b.e=f&apos;</span>
</code></pre>
<p>Empty strings and null values will omit the value, but the equals sign (=) remains in place:</p>
<pre class="hljs"><code>assert.equal(qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-string">&apos;&apos;</span> }), <span class="hljs-string">&apos;a=&apos;</span>);
</code></pre>
<p>Key with no values (such as an empty object or array) will return nothing:</p>
<pre class="hljs"><code>assert.equal(qs.stringify({ <span class="hljs-attr">a</span>: [] }), <span class="hljs-string">&apos;&apos;</span>);
...
<pre class="hljs"><code>assert.equal(qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-literal">null</span>, <span class="hljs-attr">b</span>: <span class="hljs-literal">undefined</span> }), <span class="hljs-string">&apos;a=&apos;</span>);
</code></pre>
<p>The query string may optionally be prepended with a question mark:</p>
<pre class="hljs"><code>assert.equal(qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-string">&apos;b&apos;</span>, <span class="hljs-attr">c</span>: <span class="hljs-string">&apos;d&apos;</span> }, { <span class="hljs-attr">addQueryPrefix</span>: <span class="hljs-literal">true</span> }), <span class="hljs-string">&apos;?a=b&amp;c=d&apos;</span>);
</code></pre>
<p>The delimiter may be overridden with stringify as well:</p>
<pre class="hljs"><code>assert.equal(qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-string">&apos;b&apos;</span>, <span class="hljs-attr">c</span>: <span class="hljs-string">&apos;d&apos;</span> }, { <span class="hljs-attr">delimiter</span>: <span class="hljs-string">&apos;;&apos;</span> }), <span class="hljs-string">&apos;a=b;c=d&apos;</span>);
</code></pre>
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> date = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Date</span>(<span class="hljs-number">7</span>);
...
<pre class="hljs"><code><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">alphabeticalSort</span>(<span class="hljs-params">a, b</span>) </span>{
...
<pre class="hljs"><code><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">filterFunc</span>(<span class="hljs-params">prefix, value</span>) </span>{
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> withNull = qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-literal">null</span>, <span class="hljs-attr">b</span>: <span class="hljs-string">&apos;&apos;</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> equalsInsensitive = qs.parse(<span class="hljs-string">&apos;a&amp;b=&apos;</span>);
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> strictNull = qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-literal">null</span>, <span class="hljs-attr">b</span>: <span class="hljs-string">&apos;&apos;</span> }, { <span class="hljs-attr">strictNullHandling</span>: <span class="hljs-literal">true</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> parsedStrictNull = qs.parse(<span class="hljs-string">&apos;a&amp;b=&apos;</span>, { <span class="hljs-attr">strictNullHandling</span>: <span class="hljs-literal">true</span> });
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> nullsSkipped = qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-string">&apos;b&apos;</span>, <span class="hljs-attr">c</span>: <span class="hljs-literal">null</span>}, { <span class="hljs-attr">skipNulls</span>: <span class="hljs-literal">true</span> });
...
<a href="https://en.wikipedia.org/wiki/Shift_JIS" target="_blank" rel="noopener">Shift JIS</a>) you can use the
<a href="https://github.com/martinheidegger/qs-iconv" target="_blank" rel="noopener"><code>qs-iconv</code></a> library:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> encoder = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;qs-iconv/encoder&apos;</span>)(<span class="hljs-string">&apos;shift_jis&apos;</span>);
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> decoder = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;qs-iconv/decoder&apos;</span>)(<span class="hljs-string">&apos;shift_jis&apos;</span>);
...
<pre class="hljs"><code>assert.equal(qs.stringify({ a: &apos;b c&apos; }), &apos;a=b%20c&apos;);
