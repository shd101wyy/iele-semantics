    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>argparse</h1>
<p><a href="http://travis-ci.org/nodeca/argparse" target="_blank" rel="noopener"><img src="https://secure.travis-ci.org/nodeca/argparse.svg?branch=master" alt="Build Status"></a>
<a href="https://www.npmjs.org/package/argparse" target="_blank" rel="noopener"><img src="https://img.shields.io/npm/v/argparse.svg" alt="NPM version"></a></p>
<p>CLI arguments parser for node.js. Javascript port of python&apos;s
<a href="http://docs.python.org/dev/library/argparse.html" target="_blank" rel="noopener">argparse</a> module
(original version 3.2). That&apos;s a full port, except some very rare options,
recorded in issue tracker.</p>
<p><strong>NB. Difference with original.</strong></p>
<ul>
<li>Method names changed to camelCase. See <a href="http://nodeca.github.com/argparse/" target="_blank" rel="noopener">generated docs</a>.</li>
...
<p>Parse arguments:</p>
<pre class="hljs"><code>$ ./test.js -f=3 --bar=4 --baz 5
{ foo: &apos;3&apos;, bar: &apos;4&apos;, baz: &apos;5&apos; }
</code></pre>
<p>More <a href="https://github.com/nodeca/argparse/tree/master/examples" target="_blank" rel="noopener">examples</a>.</p>
<h1>ArgumentParser objects</h1>
<pre class="hljs"><code>new ArgumentParser({parameters hash});
</code></pre>
...
<p>Details in <a href="http://docs.python.org/dev/library/argparse.html#argumentparser-objects" target="_blank" rel="noopener">original ArgumentParser guide</a></p>
<h1>addArgument() method</h1>
<pre class="hljs"><code>ArgumentParser.addArgument(name or flag or [name] or [flags...], {options})
</code></pre>
...
<p>Details in <a href="http://docs.python.org/dev/library/argparse.html#the-add-argument-method" target="_blank" rel="noopener">original add_argument guide</a></p>
...
<p>Details in <a href="http://docs.python.org/dev/library/argparse.html#action" target="_blank" rel="noopener">original action guide</a></p>
<h1>Sub-commands</h1>
...
<p>Details in <a href="http://docs.python.org/dev/library/argparse.html#sub-commands" target="_blank" rel="noopener">original sub-commands guide</a></p>
<h1>Contributors</h1>
<ul>
<li><a href="https://github.com/shkuropat" target="_blank" rel="noopener">Eugene Shkuropat</a></li>
<li><a href="https://github.com/hpaulj" target="_blank" rel="noopener">Paul Jacobson</a></li>
</ul>
<p><a href="https://github.com/nodeca/argparse/graphs/contributors" target="_blank" rel="noopener">others</a></p>
<h1>License</h1>
<p>Copyright (c) 2012 <a href="https://github.com/puzrin" target="_blank" rel="noopener">Vitaly Puzrin</a>.
Released under the MIT license. See
<a href="https://github.com/nodeca/argparse/blob/master/LICENSE" target="_blank" rel="noopener">LICENSE</a> for details.</p>
</body></html></div>
        </main>
      </div>
    </div>
