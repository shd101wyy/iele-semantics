    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>json-stringify-safe</h1>
<p>Like JSON.stringify, but doesn&apos;t throw on circular references.</p>
<h2>Usage</h2>
<p>Takes the same arguments as <code>JSON.stringify</code>.</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> stringify = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;json-stringify-safe&apos;</span>);
...
<h2>Details</h2>
<pre class="hljs"><code>stringify(obj, serializer, indent, decycler)
</code></pre>
...
the result.</p>
<pre class="hljs"><code>stringify.getSerialize(serializer, decycler)
</code></pre>
