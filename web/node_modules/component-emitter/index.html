    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Emitter <a href="https://travis-ci.org/component/emitter" target="_blank" rel="noopener"><img src="https://travis-ci.org/component/emitter.png" alt="Build Status"></a></h1>
<p>Event emitter component.</p>
<h2>Installation</h2>
<pre class="hljs"><code>$ component install component/emitter
</code></pre>
<h2>API</h2>
<h3>Emitter(obj)</h3>
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> Emitter = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;emitter&apos;</span>);
