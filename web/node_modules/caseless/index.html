    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h2>Caseless -- wrap an object to set and get property with caseless semantics but also preserve caseing.</h2>
...
<h2>Usage</h2>
<pre class="hljs"><code><span class="hljs-keyword">var</span> headers = {}
  , c = caseless(headers)
  ;
...
<pre class="hljs"><code>c.has(<span class="hljs-string">&apos;a-header&apos;</span>) === <span class="hljs-string">&apos;a-Header&apos;</span>
</code></pre>
...
<pre class="hljs"><code>c.set(<span class="hljs-string">&apos;a-Header&apos;</span>, <span class="hljs-string">&apos;fdas&apos;</span>)
