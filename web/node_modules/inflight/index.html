    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>inflight</h1>
<p>Add callbacks to requests in flight to avoid async duplication</p>
<h2>USAGE</h2>
<pre class="hljs"><code><span class="hljs-keyword">var</span> inflight = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;inflight&apos;</span>)
