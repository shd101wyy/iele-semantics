    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>has-unicode</h1>
<p>Try to guess if your terminal supports unicode</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> hasUnicode = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;has-unicode&quot;</span>)

<span class="hljs-keyword">if</span> (hasUnicode()) {
  <span class="hljs-comment">// the terminal probably has unicode support</span>
}
</code></pre>
<pre class="hljs"><code><span class="hljs-keyword">var</span> hasUnicode = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;has-unicode&quot;</span>).tryHarder
