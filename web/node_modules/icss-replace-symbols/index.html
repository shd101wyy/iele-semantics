    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><p><a href><img src="https://img.shields.io/travis/css-modules/icss-replace-symbols/master.svg?style=flat-square" alt="Build Status"></a></p>
<h1>ICSS &#x2014; Replace Symbols</h1>
<p>Governs the way tokens are searched &amp; replaced during the linking stage of ICSS loading.</p>
<p>This is broken into its own module in case the behaviour needs to be replicated in other PostCSS plugins (i.e. <a href="https://github.com/css-modules/postcss-modules-constants" target="_blank" rel="noopener">CSS Modules Constants</a>)</p>
<h2>API</h2>
<pre class="hljs"><code><span class="hljs-keyword">import</span> replaceSymbols <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;icss-replace-symbols&quot;</span>
replaceSymbols(css, translations)
</code></pre>
<p>Where:</p>
<ul>
<li><code>css</code> is the PostCSS tree you&apos;re working with</li>
<li><code>translations</code> is an JS object of <code>symbol: &quot;replacement&quot;</code> pairs, where all occurrences of <code>symbol</code> are replaced with <code>replacement</code>.</li>
</ul>
<h2>Behaviour</h2>
