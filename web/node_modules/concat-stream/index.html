    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>concat-stream</h1>
...
<p><a href="https://travis-ci.org/maxogden/concat-stream" target="_blank" rel="noopener"><img src="https://travis-ci.org/maxogden/concat-stream.svg?branch=master" alt="Build Status"></a></p>
<p><a href="https://nodei.co/npm/concat-stream/" target="_blank" rel="noopener"><img src="https://nodei.co/npm/concat-stream.png" alt="NPM"></a></p>
<h3>description</h3>
...
<h2>Related</h2>
<p><code>concat-stream</code> is part of the <a href="https://github.com/maxogden/mississippi" target="_blank" rel="noopener">mississippi stream utility collection</a> which includes more useful stream modules similar to this one.</p>
<h3>examples</h3>
<h4>Buffers</h4>
...
<h4>Arrays</h4>
<pre class="hljs"><code><span class="hljs-keyword">var</span> write = concat(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">data</span>) </span>{})
...
<h1>methods</h1>
<pre class="hljs"><code><span class="hljs-keyword">var</span> concat = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;concat-stream&apos;</span>)
</code></pre>
...
<p>We recommend using <a href="https://npmjs.org/end-of-stream" target="_blank" rel="noopener"><code>end-of-stream</code></a> or <a href="https://npmjs.org/pump" target="_blank" rel="noopener"><code>pump</code></a> for writing error tolerant stream code.</p>
<h1>license</h1>
<p>MIT LICENSE</p>
</body></html></div>
        </main>
