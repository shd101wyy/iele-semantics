    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>readdirp <a href="http://travis-ci.org/thlorenz/readdirp" target="_blank" rel="noopener"><img src="https://secure.travis-ci.org/thlorenz/readdirp.svg" alt="Build Status"></a></h1>
<p><a href="https://nodei.co/npm/readdirp/" target="_blank" rel="noopener"><img src="https://nodei.co/npm/readdirp.png?downloads=true&amp;stars=true" alt="NPM"></a></p>
<p>Recursive version of <a href="http://nodejs.org/docs/latest/api/fs.html#fs_fs_readdir_path_callback" target="_blank" rel="noopener">fs.readdir</a>. Exposes a <strong>stream api</strong>.</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> readdirp = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;readdirp&apos;</span>)
...
<p>Meant to be one of the recursive versions of <a href="http://nodejs.org/docs/latest/api/fs.html" target="_blank" rel="noopener">fs</a> functions, e.g., like <a href="https://github.com/substack/node-mkdirp" target="_blank" rel="noopener">mkdirp</a>.</p>
<p><strong>Table of Contents</strong>  <em>generated with <a href="http://doctoc.herokuapp.com/" target="_blank" rel="noopener">DocToc</a></em></p>
<ul>
...
<a href="http://nodejs.org/api/stream.html" target="_blank" rel="noopener">nodejs streams documentation</a> or the
<a href="https://github.com/substack/stream-handbook" target="_blank" rel="noopener">stream-handbook</a></li>
</ul>
<h2>options</h2>
<ul>
<li>
...
<li>
<p><strong>stat</strong>          :  built in <a href="http://nodejs.org/docs/v0.4.9/api/fs.html#fs.Stats" target="_blank" rel="noopener">stat object</a></p>
</li>
<li>
...
<li>
<p><strong>glob string</strong>: a string (e.g., <code>*.js</code>) which is matched using <a href="https://github.com/isaacs/minimatch" target="_blank" rel="noopener">minimatch</a>, so go there for more
information.</p>
...
readdirp({ <span class="hljs-attr">root</span>: <span class="hljs-string">&apos;.&apos;</span> }, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">fileInfo</span>) </span>{
...
<p>Try more examples by following <a href="https://github.com/paulmillr/readdirp/blob/master/examples/Readme.md" target="_blank" rel="noopener">instructions</a>
on how to get going.</p>
<h2>tests</h2>
<p>The <a href="https://github.com/paulmillr/readdirp/blob/master/test/readdirp.js" target="_blank" rel="noopener">readdirp tests</a> also will give you a good idea on
how things work.</p>
</body></html></div>
        </main>
      </div>
