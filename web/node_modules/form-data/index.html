    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Form-Data <a href="https://www.npmjs.com/package/form-data" target="_blank" rel="noopener"><img src="https://img.shields.io/npm/v/form-data.svg" alt="NPM Module"></a> <a href="https://gitter.im/form-data/form-data" target="_blank" rel="noopener"><img src="http://form-data.github.io/images/gitterbadge.svg" alt="Join the chat at https://gitter.im/form-data/form-data"></a></h1>
...
<p>The API of this library is inspired by the <a href="http://dev.w3.org/2006/webapi/XMLHttpRequest-2/Overview.html#the-formdata-interface" target="_blank" rel="noopener">XMLHttpRequest-2 FormData Interface</a>.</p>
<p><a href="https://travis-ci.org/form-data/form-data" target="_blank" rel="noopener"><img src="https://img.shields.io/travis/form-data/form-data/v2.3.3.svg?label=linux:4.x-9.x" alt="Linux Build"></a>
<a href="https://travis-ci.org/form-data/form-data" target="_blank" rel="noopener"><img src="https://img.shields.io/travis/form-data/form-data/v2.3.3.svg?label=macos:4.x-9.x" alt="MacOS Build"></a>
<a href="https://ci.appveyor.com/project/alexindigo/form-data" target="_blank" rel="noopener"><img src="https://img.shields.io/appveyor/ci/alexindigo/form-data/v2.3.3.svg?label=windows:4.x-9.x" alt="Windows Build"></a></p>
<p><a href="https://coveralls.io/github/form-data/form-data?branch=master" target="_blank" rel="noopener"><img src="https://img.shields.io/coveralls/form-data/form-data/v2.3.3.svg?label=code+coverage" alt="Coverage Status"></a>
<a href="https://david-dm.org/form-data/form-data" target="_blank" rel="noopener"><img src="https://img.shields.io/david/form-data/form-data.svg" alt="Dependency Status"></a>
<a href="https://www.bithound.io/github/form-data/form-data" target="_blank" rel="noopener"><img src="https://www.bithound.io/github/form-data/form-data/badges/score.svg" alt="bitHound Overall Score"></a></p>
<h2>Install</h2>
<pre class="hljs"><code>npm install --save form-data
</code></pre>
<h2>Usage</h2>
<p>In this example we are constructing a form with 3 fields that contain a string,
a buffer and a file stream.</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> FormData = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;form-data&apos;</span>);
...
<p>Or @mikeal&apos;s <a href="https://github.com/request/request" target="_blank" rel="noopener">request</a> stream:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> FormData = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;form-data&apos;</span>);
...
<pre class="hljs"><code>form.submit(<span class="hljs-string">&apos;http://example.org/&apos;</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">err, res</span>) </span>{
...
<p>List of available options could be found in <a href="https://github.com/felixge/node-combined-stream/blob/master/lib/combined_stream.js#L7-L15" target="_blank" rel="noopener">combined-stream</a></p>
...
<pre class="hljs"><code>form.submit(<span class="hljs-string">&apos;example.org/upload&apos;</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">err, res</span>) </span>{
  <span class="hljs-built_in">console</span>.log(res.statusCode);
});
</code></pre>
<p>To use custom headers and pre-known length in parts:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> CRLF = <span class="hljs-string">&apos;\r\n&apos;</span>;
<span class="hljs-keyword">var</span> form = <span class="hljs-keyword">new</span> FormData();
...
<pre class="hljs"><code>someModule.stream(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">err, stdout, stderr</span>) </span>{
  <span class="hljs-keyword">if</span> (err) <span class="hljs-keyword">throw</span> err;
...
<p>The <code>filepath</code> property overrides <code>filename</code> and may contain a relative path. This is typically used when uploading <a href="https://wicg.github.io/entries-api/#dom-htmlinputelement-webkitdirectory" target="_blank" rel="noopener">multiple files from a directory</a>.</p>
...
<pre class="hljs"><code>form.submit({
...
<h4>Request</h4>
<p>Form submission using  <a href="https://github.com/request/request" target="_blank" rel="noopener">request</a>:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> formData = {
...
<p>For more details see <a href="https://github.com/request/request#multipartform-data-multipart-form-uploads" target="_blank" rel="noopener">request readme</a>.</p>
<h4>node-fetch</h4>
<p>You can also submit a form using <a href="https://github.com/bitinn/node-fetch" target="_blank" rel="noopener">node-fetch</a>:</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> form = <span class="hljs-keyword">new</span> FormData();
