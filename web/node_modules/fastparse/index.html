    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>fastparse</h1>
...
<pre class="hljs"><code><span class="hljs-keyword">new</span> Parser(description)
...
<pre class="hljs"><code>Parser.prototype.parse(initialState: <span class="hljs-built_in">String</span>, <span class="hljs-attr">parsedString</span>: <span class="hljs-built_in">String</span>, <span class="hljs-attr">context</span>: <span class="hljs-built_in">Object</span>)
</code></pre>
...
<h2>Example</h2>
<pre class="hljs"><code><span class="hljs-keyword">var</span> Parser = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;fastparse&quot;</span>);
...
<span class="hljs-keyword">var</span> parser = <span class="hljs-keyword">new</span> Parser({
	...
	<span class="hljs-string">&quot;comment&quot;</span>: {
		...
		<span class="hljs-string">&quot;@licen[cs]e\\s((?:[^*\n]|\\*+[^*/\n])*)&quot;</span>: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">match, licenseText</span>) </span>{
			<span class="hljs-built_in">this</span>.licences.push(licenseText.trim());
		}
	},
...
<h2>License</h2>
<p>MIT (<a href="http://www.opensource.org/licenses/mit-license.php" target="_blank" rel="noopener">http://www.opensource.org/licenses/mit-license.php</a>)</p>
</body></html></div>
        </main>
      </div>
    </div>
