    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>asynckit <a href="https://www.npmjs.com/package/asynckit" target="_blank" rel="noopener"><img src="https://img.shields.io/npm/v/asynckit.svg?style=flat" alt="NPM Module"></a></h1>
<p>Minimal async jobs utility library, with streams support.</p>
<p><a href="https://travis-ci.org/alexindigo/asynckit" target="_blank" rel="noopener"><img src="https://img.shields.io/travis/alexindigo/asynckit/v0.4.0.svg?label=browser&amp;style=flat" alt="PhantomJS Build"></a>
<a href="https://travis-ci.org/alexindigo/asynckit" target="_blank" rel="noopener"><img src="https://img.shields.io/travis/alexindigo/asynckit/v0.4.0.svg?label=linux:0.12-6.x&amp;style=flat" alt="Linux Build"></a>
<a href="https://ci.appveyor.com/project/alexindigo/asynckit" target="_blank" rel="noopener"><img src="https://img.shields.io/appveyor/ci/alexindigo/asynckit/v0.4.0.svg?label=windows:0.12-6.x&amp;style=flat" alt="Windows Build"></a></p>
<p><a href="https://coveralls.io/github/alexindigo/asynckit?branch=master" target="_blank" rel="noopener"><img src="https://img.shields.io/coveralls/alexindigo/asynckit/v0.4.0.svg?label=code+coverage&amp;style=flat" alt="Coverage Status"></a>
<a href="https://david-dm.org/alexindigo/asynckit" target="_blank" rel="noopener"><img src="https://img.shields.io/david/alexindigo/asynckit/v0.4.0.svg?style=flat" alt="Dependency Status"></a>
<a href="https://www.bithound.io/github/alexindigo/asynckit" target="_blank" rel="noopener"><img src="https://www.bithound.io/github/alexindigo/asynckit/badges/score.svg" alt="bitHound Overall Score"></a></p>
...
<h2>Install</h2>
<pre class="hljs"><code>$ npm install --save asynckit
</code></pre>
<h2>Examples</h2>
<h3>Parallel Jobs</h3>
...
<h4>Input Array</h4>
<pre class="hljs"><code><span class="hljs-keyword">var</span> parallel = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;asynckit&apos;</span>).parallel
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">asyncJob</span>(<span class="hljs-params">item, cb</span>)
  ...
  <span class="hljs-keyword">var</span> timeoutId = <span class="hljs-built_in">setTimeout</span>(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    target.push(item);
  ...
  <span class="hljs-keyword">return</span> <span class="hljs-built_in">clearTimeout</span>.bind(<span class="hljs-literal">null</span>, timeoutId);
}
</code></pre>
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> parallel = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;asynckit/parallel&apos;</span>)
  , assert   = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;assert&apos;</span>)
  ;
...
and return error along with salvaged data to the main callback function.</p>
<h4>Input Array</h4>
<pre class="hljs"><code><span class="hljs-keyword">var</span> serial = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;asynckit/serial&apos;</span>)
  , assert = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;assert&apos;</span>)
  ;
...
<h4>Input Object</h4>
<p>Also it supports named jobs, listed via object.</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> serial = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;asynckit&apos;</span>).serial
  , assert = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;assert&apos;</span>)
  ;
...
<p>Or open an <a href="https://github.com/alexindigo/asynckit/issues" target="_blank" rel="noopener">issue</a> with questions and/or suggestions.</p>
<h2>License</h2>
