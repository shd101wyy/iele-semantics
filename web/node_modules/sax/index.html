    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>sax js</h1>
<p>A sax-style parser for XML and HTML.</p>
<p>Designed with <a href="http://nodejs.org/" target="_blank" rel="noopener">node</a> in mind, but should work fine in
...
<h2>Usage</h2>
<pre class="hljs"><code><span class="hljs-keyword">var</span> sax = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;./lib/sax&quot;</span>),
...
saxStream.on(<span class="hljs-string">&quot;error&quot;</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">e</span>) </span>{
  ...
  <span class="hljs-built_in">this</span>._parser.error = <span class="hljs-literal">null</span>
  <span class="hljs-built_in">this</span>._parser.resume()
})
...
<li><code>strictEntities</code> - Boolean. If true, only parse <a href="http://www.w3.org/TR/REC-xml/#sec-predefined-ent" target="_blank" rel="noopener">predefined XML
entities</a>
