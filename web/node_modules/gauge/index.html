    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>gauge</h1>
<p>A nearly stateless terminal based horizontal gauge / progress bar.</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> Gauge = <span class="hljs-built_in">require</span>(<span class="hljs-string">&quot;gauge&quot;</span>)
...
<p>Gauge 2.x is breaking release, please see the <a href="CHANGELOG/">changelog</a> for details on
...
<pre class="hljs"><code>var Gauge = require(&quot;gauge&quot;)
...
of, you may find the related <a href="https://www.npmjs.com/package/are-we-there-yet" target="_blank" rel="noopener">are-we-there-yet</a> helpful.  It&apos;s <code>change</code>
event can be wired up to the <code>show</code> method to get a more traditional
progress bar interface.</p>
<h3>THEMES</h3>
<pre class="hljs"><code>var themes = require(&apos;gauge/themes&apos;)
...
<pre class="hljs"><code>var ThemeSet = require(&apos;gauge/theme-set&apos;)
...
<pre class="hljs"><code>var Plumbing = require(&apos;gauge/plumbing&apos;)
