    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>color-convert</h1>
<p><a href="https://travis-ci.org/Qix-/color-convert" target="_blank" rel="noopener"><img src="https://travis-ci.org/Qix-/color-convert.svg?branch=master" alt="Build Status"></a></p>
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> convert = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;color-convert&apos;</span>);
...
<h1>Install</h1>
<pre class="hljs"><code><span class="hljs-meta">$</span><span class="bash"> npm install color-convert</span>
</code></pre>
<h1>API</h1>
