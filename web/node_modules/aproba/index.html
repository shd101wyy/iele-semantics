    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>aproba</h1>
<p>A ridiculously light-weight function argument validator</p>
<pre class="hljs"><code>var validate = require(&quot;aproba&quot;)
...
<pre class="hljs"><code>fs.createWriteStream(path[, options])
</code></pre>
...
<pre class="hljs"><code>path &lt;String&gt; | &lt;Buffer&gt;
