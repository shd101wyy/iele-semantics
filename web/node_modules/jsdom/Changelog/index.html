    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><!-- Style guide:
...
--><html><head></head><body><h2>14.1.0</h2>
<ul>
...
<li>Updated the minimum <a href="https://www.npmjs.com/package/nwsapi" target="_blank" rel="noopener"><code>nwsapi</code></a> version from v2.1.1 to v2.1.3, bringing along a few fixes in our selector engine.</li>
</ul>
<h2>14.0.0</h2>
<p>Breaking changes:</p>
<ul>
<li><code>JSDOM.fragment()</code> now creates fragments whose document has no <a href="https://html.spec.whatwg.org/multipage/#concept-document-bc" target="_blank" rel="noopener">browsing context</a>, i.e. no associated <code>Window</code>. This means the <code>defaultView</code> property will be null, resources will not load, etc.</li>
...
<li>Upgraded our <a href="https://github.com/lddubeau/saxes" target="_blank" rel="noopener"><code>saxes</code></a> dependency, so that it now correctly errors on XML fragments like <code>&lt;foo bar:=&quot;1&quot;/&gt;</code>.</li>
</ul>
<h2>13.1.0</h2>
<ul>
...
<li>Fixed the performance of parsing large text nodes, particularly noticeable for large inline <code>&lt;style&gt;</code> or <code>&lt;script&gt;</code> elements. This regressed in v11.6.0. To learn more, see <a href="https://bugs.chromium.org/p/v8/issues/detail?id=6730#c4" target="_blank" rel="noopener">V8 issue #6730</a>.</li>
...
<li>Fixed radio button group name matching to be case-sensitive, per <a href="https://github.com/whatwg/html/commit/6acdb2122298d2bb7bb839c0a61b4e1f9b0f9bc9" target="_blank" rel="noopener">a spec update</a>.</li>
...
<p>Breaking change:</p>
<ul>
<li>Removed support for v1.x of the <a href="https://github.com/Automattic/node-canvas" target="_blank" rel="noopener"><code>canvas</code></a> package, in favor of v2.x. This also removes support for <code>canvas-prebuilt</code>, since <code>canvas</code> v2.x has a built-in prebuilt version.</li>
</ul>
<p>Other changes:</p>
<ul>
<li>Added proper XML serialization, based on the <a href="https://github.com/jsdom/w3c-xmlserializer" target="_blank" rel="noopener"><code>w3c-xmlserializer</code></a> package. Previously we were just using the HTML serialization, even in XML documents.</li>
...
<li>Fixed our implementation of the node tree modification constraints (for example the <a href="https://dom.spec.whatwg.org/#concept-node-ensure-pre-insertion-validity" target="_blank" rel="noopener">ensure pre-insertion validity</a> algorithm). It is no longer possible to add, remove, or move nodes to create impossible DOM trees. (pmdartus)</li>
</ul>
<h2>12.2.0</h2>
<ul>
...
<h2>12.0.0</h2>
<p>This major release brings along our <a href="https://github.com/jsdom/jsdom#loading-subresources" target="_blank" rel="noopener">new resource loader API</a>, finally bringing all the capabilities from jsdom v9 to the new (jsdom v10+) API. Thanks very much to <a href="https://github.com/sarvaje" target="_blank" rel="noopener">@sarvaje</a> for his work to make this possible!</p>
<p>Breaking changes:</p>
<ul>
<li>jsdom now requires Node.js v8.</li>
<li>Removed the old jsdom API, as the new API now has all the capabilities you need.</li>
<li>Updated our <a href="https://github.com/inikulin/parse5/" target="_blank" rel="noopener"><code>parse5</code></a> dependency to v5, which changes the format of the node locations returned by <code>dom.nodeLocation()</code>.</li>
<li>Updated our <a href="https://github.com/jsdom/whatwg-url" target="_blank" rel="noopener"><code>whatwg-url</code></a> dependency to v7, which changes the origin of <code>file:</code> URLs to be an opaque origin (and thus <code>file:</code> URLs are no longer same origin to each other).</li>
</ul>
<p>Other changes:</p>
<ul>
...
<li>Improved MIME type and <code>data:</code> URL parsing throughout jsdom, by using the new <a href="https://www.npmjs.com/package/whatwg-mimetype" target="_blank" rel="noopener"><code>whatwg-mimetype</code></a> and <a href="https://www.npmjs.com/package/data-urls" target="_blank" rel="noopener"><code>data-urls</code></a> packages.</li>
...
<p>Another regression remains where we are emitting spurious CSS-parsing <code>jsdomError</code> events; see <a href="https://github.com/tmpvar/jsdom/issues/2123" target="_blank" rel="noopener">#2123</a>. We also discovered a large amount of preexisting brokenness around <code>&lt;style&gt;</code>, <code>&lt;link&gt;</code>, and <code>@import</code>; see <a href="https://github.com/tmpvar/jsdom/issues/2124" target="_blank" rel="noopener">#2124</a> for more details.</p>
...
<li>Added a <code>window.performance</code> implementation, including the basics of the <a href="https://w3c.github.io/hr-time/" target="_blank" rel="noopener">High Resolution Time</a> specification: <code>performance.now()</code>, <code>performance.timeOrigin</code>, and <code>performance.toJSON()</code>.</li>
...
<li>Fixed all URL-accepting properties to properly perform <a href="https://infra.spec.whatwg.org/#javascript-string-convert" target="_blank" rel="noopener">scalar value string conversion</a> and URL resolution.</li>
<li>Fixed many other small edge-case conformance issues in the API surface of various web APIs; see <a href="https://github.com/tmpvar/jsdom/pull/2053" target="_blank" rel="noopener">#2053</a> and <a href="https://github.com/tmpvar/jsdom/pull/2081" target="_blank" rel="noopener">#2081</a> for more information.</li>
...
<h2>11.4.0</h2>
<p>For this release we&apos;d like to welcome <a href="https://github.com/tmpvar/jsdom/commits?author=Zirro" target="_blank" rel="noopener">@Zirro</a> to the core team; his contributions over the course of this year have enhanced jsdom immensely.</p>
<ul>
...
<li>Removed the <code>&lt;applet&gt;</code> element, <a href="https://github.com/whatwg/html/pull/1399" target="_blank" rel="noopener">following the spec</a>.</li>
</ul>
<h2>11.3.0</h2>
<p>For this release we&apos;d like to formally welcome <a href="https://github.com/tmpvar/jsdom/commits?author=TimothyGu" target="_blank" rel="noopener">@TimothyGu</a> to the core team, as a prolific contributor. He will join the illustrious ranks of those who do so much work on jsdom that we no longer note their names in the changelog.</p>
<ul>
...
<p>This infrastructure will allow us to improve and implement many other similar behaviors; that work is being tracked in <a href="https://github.com/tmpvar/jsdom/issues/1129" target="_blank" rel="noopener">#1129</a>.</p>
...
<li>Updated the interaction between a <code>&lt;textarea&gt;</code>&apos;s <code>value</code>, <code>defaultValue</code>, and <code>textContent</code> per <a href="https://github.com/whatwg/html/commit/5afbba1cf62ee01bc6af3fd220d01f3f7591a0fc" target="_blank" rel="noopener">a recent spec change</a></li>
...
<p>Breaking changes:</p>
<ul>
<li>Custom parsers, via the <code>parser</code> option to the old API, can no longer be specified. They were never tested, often broken, and a maintenance burden. The defaults, of <a href="https://www.npmjs.com/package/parse5" target="_blank" rel="noopener">parse5</a> for HTML and <a href="https://www.npmjs.com/package/sax" target="_blank" rel="noopener">sax</a> for XML, now always apply.</li>
...
<li><strong>Changed the <code>omitJsdomErrors</code> option to <code>omitJSDOMErrors</code></strong>, for consistency <a href="https://w3ctag.github.io/design-principles/#casing-rules" target="_blank" rel="noopener">with web platform APIs</a>.</li>
...
<li>Changed <code>navigator.vendor</code> to return <code>&quot;Apple Computer, Inc.&quot;</code> instead of <code>&quot;Google Inc.&quot;</code>, since we have chosen the WebKit <a href="https://html.spec.whatwg.org/multipage/webappapis.html#concept-navigator-compatibility-mode" target="_blank" rel="noopener">navigator compatibility mode</a>.</li>
</ul>
<h2>9.9.1</h2>
<ul>
...
<li>Tweaked the behavior of calling <code>event.stopPropagation</code> and <code>event.stopImmediatePropagation</code> on already-dispatched events, per <a href="https://github.com/whatwg/dom/commit/806d4aab584f6fc38c21f8e088b51b8ba3e27e20" target="_blank" rel="noopener">the latest changes to the DOM Standard</a>.</li>
</ul>
<h2>9.5.0</h2>
<ul>
...
<li>Upgraded the minimum tough-cookie version to ensure all installations are protected against <a href="https://nodesecurity.io/advisories/130" target="_blank" rel="noopener">a security advisory</a>.</li>
</ul>
<h2>9.4.1</h2>
<ul>
...
<li>Updated <code>FormData</code> for <a href="https://github.com/whatwg/xhr/commit/1a75845e67792418a7721d516266ad01a90f2062" target="_blank" rel="noopener">recent spec fixes</a>: blobs, files, and filenames should now all work like you&apos;d expect.</li>
<li>Updated the <code>FormData</code> constructor to use the proper, rather-complex, <a href="https://html.spec.whatwg.org/multipage/forms.html#constructing-form-data-set" target="_blank" rel="noopener">constructing the form data set</a> algorithm.</li>
...
<h2>9.2.1</h2>
<ul>
<li>Fixed <code>&lt;input&gt;</code>&apos;s <code>selectionStart</code>, <code>selectionEnd</code>, and <code>selectionDirection</code> getters to return null, instead of throwing, for elements that do not allow selection, per <a href="https://github.com/whatwg/html/pull/1006" target="_blank" rel="noopener">a recent spec change</a>.</li>
<li>Fixed <code>&lt;base&gt;</code>&apos;s <code>href</code> getter logic to return the attribute value instead of the empty string for unparseable URLs, per <a href="https://github.com/whatwg/html/pull/1064" target="_blank" rel="noopener">a recent spec change</a>.</li>
...
<p>However, recent performance investigations revealed that mutation events were the major bottleneck in most jsdom operations; tools like <a href="https://github.com/bterlson/ecmarkup" target="_blank" rel="noopener">ecmarkup</a> which make heavy use of jsdom had their running time halved by removing mutation events, which add serious overhead to every DOM mutation. As such, we are doing a major release with them removed, so that jsdom users can benefit from this massive performance gain.</p>
<p>Mutation observer support is <a href="https://github.com/tmpvar/jsdom/issues/639" target="_blank" rel="noopener">in progress</a>; please use the GitHub reactions feature to vote on that issue if you are impacted by this removal and are hoping for mutation observer support to replace it.</p>
...
<li>Added a basic implementation of the <a href="https://w3c.github.io/page-visibility/" target="_blank" rel="noopener">Page Visibility API</a>, in particular a <code>document.hidden</code> property that always returns <code>true</code>, and a <code>document.visibilityState</code> property that always returns <code>&quot;prerender&quot;</code>. This is a more standard alternative to our proprietary <code>navigator.noUI</code>, which will be removed whenever we release v9.0.0. (kapouer)</li>
</ul>
<h2>8.2.0</h2>
<ul>
...
<h2>8.1.0</h2>
<ul>
<li>Added <code>attr.nodeName</code>, which was <a href="https://github.com/whatwg/dom/issues/171" target="_blank" rel="noopener">recently re-added to the spec</a>.</li>
...
<ul>
<li>Added <code>element.getAttributeNames()</code>. (<a href="https://github.com/whatwg/dom/issues/115" target="_blank" rel="noopener">spec addition</a>)</li>
<li><code>setAttributeNode</code> and <code>setAttributeNodeNS</code> can now replace an attribute node, instead of removing the old one and adding a new one; this avoids changing the order in the attribute list. (<a href="https://github.com/whatwg/dom/issues/116" target="_blank" rel="noopener">spec change</a>)</li>
<li><code>NamedNodeMap</code> named properties are now lowercase (except in edge cases involving XML documents or non-HTML elements). (<a href="https://github.com/whatwg/dom/issues/141" target="_blank" rel="noopener">spec change</a>)</li>
...
<li>Updated <code>DOMTokenList</code> to have a <code>value</code> property per <a href="https://github.com/whatwg/dom/issues/119" target="_blank" rel="noopener">recent spec changes</a>; its <code>toString</code> serialization also changed slightly.</li>
...
<li>Removed the <code>&quot;keyevents&quot;</code> alias for <code>&quot;keyboardevent&quot;</code> when using <code>document.createEvent</code>, <a href="https://github.com/whatwg/dom/issues/148" target="_blank" rel="noopener">per recent spec changes</a>.</li>
</ul>
<h2>8.0.4</h2>
<ul>
...
<li>Removed <a href="http://www.w3.org/TR/2003/CR-DOM-Level-3-LS-20031107/load-save.html" target="_blank" rel="noopener">&quot;DOM Load and Save&quot;</a> stub implementation. That spec was never implemented in browsers, and jsdom only contained stubs.</li>
...
<li>Replaced our default XML parser with <a href="https://www.npmjs.com/package/sax" target="_blank" rel="noopener">sax</a>, thus fixing many (but not all) issues with XML and XHTML parsing. To get a flavor of the issues fixed, check out these now-closed bugs: <a href="https://github.com/tmpvar/jsdom/issues/393" target="_blank" rel="noopener">#393</a>, <a href="https://github.com/tmpvar/jsdom/issues/651" target="_blank" rel="noopener">#651</a>, <a href="https://github.com/tmpvar/jsdom/issues/415" target="_blank" rel="noopener">#415</a>, <a href="https://github.com/tmpvar/jsdom/issues/1276" target="_blank" rel="noopener">#1276</a>.</li>
...
<h2>7.0.0</h2>
<p>This major release has as its headlining feature a completely re-written <code>XMLHttpRequest</code> implementation, in a heroic effort by <a href="https://github.com/nicolashenry" target="_blank" rel="noopener">@nicolashenry</a>. It includes a number of other smaller improvements and fixes. The breaking changes are highlighted in bold below.</p>
<ul>
...
<li>When you provide a <code>url: ...</code> option to <code>jsdom.jsom()</code> or <code>jsdom.env()</code>, the given string is now attempted to be resolved as a URL before it is installed as <code>document.URL</code>.
<ul>
...
<p>This release also welcomes <a href="https://github.com/tmpvar/jsdom/commits/master?author=Joris-van-der-Wel" target="_blank" rel="noopener">long-time contributer</a> <a href="https://github.com/Joris-van-der-Wel/" target="_blank" rel="noopener">@Joris-van-der-Wel</a> to the core team. You may recognize him from earlier changelogs. We&apos;re very happy to have his help in making jsdom awesome!</p>
<ul>
...
<li>Overhauled everything dealing with tree traversal to use a new library, <a href="https://github.com/jsdom/js-symbol-tree" target="_blank" rel="noopener">symbol-tree</a>, to turn many operations that were previously O(n^2) or O(n) into O(n) or O(1).</li>
...
<li>URL parsing and resolution was entirely overhauled to follow <a href="http://url.spec.whatwg.org/" target="_blank" rel="noopener">the URL standard</a>!
<ul>
...
<li>The new <a href="https://url.spec.whatwg.org/#url" target="_blank" rel="noopener"><code>URL</code> class</a> has been added to <code>window</code></li>
<li>The interfaces for <code>HTMLAnchorElement.prototype</code> and <code>document.location</code> (as well as <code>URL</code>, of course) are now uniformized to follow the <a href="https://url.spec.whatwg.org/#api" target="_blank" rel="noopener"><code>URLUtils</code> API</a> (minus <code>searchParams</code> for now).</li>
...
<h2>5.6.0</h2>
<ul>
<li><code>virtualConsole.sendTo</code> now returns <code>this</code>, allowing for <a href="https://github.com/tmpvar/jsdom/tree/60ccb9b318d0bae8fe37e19af5af444b9c98ddac#forward-a-windows-console-output-to-the-iojs-console" target="_blank" rel="noopener">a nice shorthand</a>. (jeffcarp)</li>
</ul>
<h2>5.5.0</h2>
<ul>
...
<ul>
<li>Elements with weird tag names, of the type that only the parser can normally create, can now be cloned (<a href="https://github.com/tmpvar/jsdom/issues/1142" target="_blank" rel="noopener">#1142</a>)</li>
...
<p>Additionally, Joris-van-der-Wel added <a href="https://github.com/tmpvar/jsdom/blob/master/Contributing.md#running-the-benchmarks" target="_blank" rel="noopener">a benchmarking framework</a>, and a number of benchmarks, which should help us avoid performance regressions going forward, and also make targeted performance fixes. We&apos;re already investigating <a href="https://github.com/tmpvar/jsdom/issues/1156" target="_blank" rel="noopener">some real-world issues</a> using this framework. Very exciting!</p>
<h2>5.4.3</h2>
<ul>
...
<ul>
<li>Notably, this makes jQuery&apos;s <code>show()</code> and <code>hide()</code> methods now work correctly; see <a href="https://github.com/tmpvar/jsdom/issues/994" target="_blank" rel="noopener">#994</a>.</li>
</ul>
</li>
...
<ul>
<li>Implemented the <a href="https://dom.spec.whatwg.org/#nondocumenttypechildnode" target="_blank" rel="noopener"><code>NonDocumentTypeChildNode</code></a> mixin. Practically, this means adding <code>nextElementSibling</code> and <code>previousElementSibling</code> to <code>Element</code> and the various types of <code>CharacterData</code>. (brandon-bethke-neudesic)</li>
...
<li>Some weirdnesses around the <code>style</code> attribute were fixed along the way; see e.g. <a href="https://github.com/tmpvar/jsdom/issues/1109" target="_blank" rel="noopener">#1109</a>.</li>
...
<h2>5.3.0</h2>
<ul>
<li>Added a <code>virtualConsole</code> option to the document creation methods, along with the <code>jsdom.createVirtualConsole</code> factory. (See <a href="https://github.com/tmpvar/jsdom/blob/dbf88666d1152576237ed1c741263f5516bb4005/README.md#capturing-console-output" target="_blank" rel="noopener">examples in the readme</a>.) With this option you can install a virtual console before the document is even created, thus allowing you to catch any virtual console events that occur during initialization. (jeffcarp)</li>
</ul>
<h2>5.2.0</h2>
<ul>
<li>Implemented much of the <a href="https://dom.spec.whatwg.org/#interface-parentnode" target="_blank" rel="noopener"><code>ParentNode</code></a> mixin (Joris-van-der-Wel):
<ul>
...
<h2>5.0.0</h2>
<p>This release overhauls how cookies are handled in jsdom to be less fiddly and more like-a-browser. The work for this was done by <a href="https://github.com/inikulin" target="_blank" rel="noopener">@inikulin</a>, who is also our beloved parse5 maintainer.</p>
...
<p>Finally, it&apos;s worth noting that we now delegate our cookie handling in general to the <a href="https://www.npmjs.com/package/tough-cookie" target="_blank" rel="noopener">tough-cookie</a> package, which should hopefully mean that it now captures many of the behaviors that were previously missing (for example <a href="https://github.com/tmpvar/jsdom/issues/1027" target="_blank" rel="noopener">#1027</a>). @inikulin is working on <a href="https://github.com/goinstant/tough-cookie/pull/30" target="_blank" rel="noopener">a large pull request to fix tough-cookie to be more spec compliant</a>, which should automatically be picked up by jsdom installs once it is merged.</p>
<h2>4.5.1</h2>
<ul>
...
<h2>4.4.0</h2>
<ul>
<li>All resources are now loaded with the <a href="https://www.npmjs.com/package/request" target="_blank" rel="noopener">request</a> package, which means that e.g. GZIPped resources will be properly uncompressed, redirects will be followed, and more. This was previously the case only for URLs passed directly to <code>jsdom.env</code>, and not for sub-resources inside the resulting page. (ssesha)</li>
</ul>
<h2>4.3.0</h2>
<ul>
...
<p>Note that as of this release, jsdom no longer works with Node.js&#x2122;, and instead requires io.js. You are still welcome to install a release in <a href="https://github.com/tmpvar/jsdom/tree/3.x" target="_blank" rel="noopener">the 3.x series</a> if you are stuck on legacy technology like Node.js&#x2122;.</p>
...
<li>Fixed a couple small issues while browserifying, mainly around <code>jsdom.env</code>. However, while doing so discovered that <code>&lt;script&gt;</code>s in general don&apos;t work too well in a browserified jsdom; see <a href="https://github.com/tmpvar/jsdom/issues/1023" target="_blank" rel="noopener">#1023</a>.</li>
</ul>
<h2>3.1.0</h2>
<ul>
<li>Added support for <a href="https://github.com/tmpvar/jsdom#custom-external-resource-loader" target="_blank" rel="noopener">custom external resource loading</a>. (tobie)</li>
</ul>
<h2>3.0.3</h2>
<ul>
<li>Fixed some stray byte-order marks in a couple files, which incidentally <a href="https://github.com/substack/node-browserify/issues/1095" target="_blank" rel="noopener">break Browserify</a>. (sterpe)</li>
</ul>
<h2>3.0.2</h2>
<ul>
...
<p>3.0.x will be the last release of jsdom to support Node.js. All future releases (starting with 4.0.0) will require <a href="https://iojs.org/" target="_blank" rel="noopener">io.js</a>, whose <a href="https://github.com/iojs/io.js/blob/v1.x/CHANGELOG.md#vm" target="_blank" rel="noopener">new <code>vm</code> module</a> will allow us to remove our contextify native-module dependency. (Given that I submitted the relevant patch to joyent/node <a href="https://github.com/joyent/node/commit/7afdba6e0bc3b69c2bf5fdbd59f938ac8f7a64c5" target="_blank" rel="noopener">1.5 years ago</a>, I&apos;m very excited that we can finally use it!)</p>
<ul>
...
<li>Introduced a new &quot;virtual console&quot; abstraction for capturing console output from inside the page. <a href="https://github.com/tmpvar/jsdom#capturing-console-output" target="_blank" rel="noopener">See the readme for more information.</a> Note that <code>console.error</code> will no longer contribute to the (non-standard, and likely dying in the future) <code>window.errors</code> array. (jeffcarp)</li>
...
<h2>2.0.0</h2>
<p>This release is largely a refactoring release to remove the defunct concept of &quot;levels&quot; from jsdom, in favor of the <a href="https://wiki.whatwg.org/wiki/FAQ#What_does_.22Living_Standard.22_mean.3F" target="_blank" rel="noopener">living standard model</a> that browsers follow. Although the code is still organized that way, that&apos;s now <a href="https://github.com/tmpvar/jsdom/blob/2ff5747488ad4b518fcef97a026c82eab42a0a14/lib/README.md" target="_blank" rel="noopener">noted as a historical artifact</a>. The public API changes while doing so were fairly minimal, but this sets the stage for a cleaner jsdom code structure going forward.</p>
<ul>
...
<h2>1.5.0</h2>
<ul>
<li>Add: missing <code>window.console</code> methods, viz. <code>assert</code>, <code>clear</code>, <code>count</code>, <code>debug</code>, <code>group</code>, <code>groupCollapse</code>, <code>groupEnd</code>, <code>table</code>, <code>time</code>, <code>timeEnd</code>, and <code>trace</code>. All except <code>assert</code> do nothing for now, but see <a href="https://github.com/tmpvar/jsdom/issues/979" target="_blank" rel="noopener">#979</a> for future plans. (jeffcarp)</li>
...
<h2>1.0.2</h2>
<ul>
<li>Fix: temporarily pin <code>cssstyle</code> dependency to at most 0.2.18 until <a href="https://github.com/chad3814/CSSStyleDeclaration/issues/20" target="_blank" rel="noopener">chad3814/CSSStyleDeclaration#20</a> is fixed.</li>
...
<li>Fix: using <code>jsom.env</code> in a browser environment now correctly defaults <code>options.url</code> to <code>location.href</code> instead of trying to infer a reasonable <code>fil://</code> URL using techniques that fail in the browser. (rattrayalex)</li>
</ul>
<h2>1.0.1</h2>
<ul>
...
<h2>1.0.0</h2>
<p>For a consolidated list of changes from 0.11.1 to 1.0.0, see <a href="https://github.com/tmpvar/jsdom/wiki/Changes-from-0.11.1-to-1.0.0" target="_blank" rel="noopener">this wiki page</a>.</p>
<ul>
...
<h2>1.0.0-pre.1</h2>
<p>This is a prerelease of jsdom&apos;s first major version. It incorporates several great additions, as well as a general cleanup of the API surface, which make it more backward-incompatible than usual. Starting with the 1.0.0 release, we will be following semantic versioning, so that you can depend on stability within major version ranges. But we still have <a href="https://github.com/tmpvar/jsdom/issues?q=is%3Aopen+is%3Aissue+milestone%3A1.0" target="_blank" rel="noopener">a few more issues</a> before we can get there, so I don&apos;t want to do 1.0.0 quite yet.</p>
<p>This release owes a special thanks to <a href="https://github.com/Sebmaster" target="_blank" rel="noopener">@Sebmaster</a>, for his amazing work taking on some of the hardest problems in jsdom and solving them with gusto.</p>
<h3>Major changes</h3>
<ul>
...
<li>An overhaul of the <a href="https://github.com/tmpvar/jsdom#initialization-lifecycle" target="_blank" rel="noopener">initialization lifecycle</a>, to bring more control and address common use cases. (Sebmaster)</li>
<li>The excellent <a href="https://npmjs.org/package/parse5" target="_blank" rel="noopener">parse5</a> HTML parser is now the default parser, fixing many parsing bugs and giving us full, official-test-suite-passing HTML parsing support. This especially impacts documents that didn&apos;t include optional tags like <code>&lt;html&gt;</code>, <code>&lt;head&gt;</code>, or <code>&lt;body&gt;</code> in their source. We also use parse5 for serialization, fixing many bugs there. (Sebmaster)</li>
<li>As part of the new parser story, we are not supporting XML for now. It might work if you switch to a different parser (e.g. htmlparser2), but in the end, HTML and XML are very different, and we are not attempting to be an XML DOM. That said, we eventually want to support XML to the same extent browsers do (i.e., support XHTML and SVG, with an appropriate MIME type switch); this is being planned in <a href="https://github.com/tmpvar/jsdom/issues/820" target="_blank" rel="noopener">#820</a>.</li>
</ul>
...
<li><code>jsdom.jQueryify</code> now requires a jQuery URL, since <a href="http://blog.jquery.com/2014/07/03/dont-use-jquery-latest-js/" target="_blank" rel="noopener">always picking the latest was a bad idea</a>.</li>
</ul>
...
<h2>0.6.0</h2>
<p>Integrated a new HTML parser, <a href="https://npmjs.org/package/htmlparser2" target="_blank" rel="noopener">htmlparser2</a>, from fb55. This is an actively maintained and much less buggy parser, fixing many of our parsing issues, including:</p>
<ul>
...
<li>Add: support for running the tests using @aredridel&apos;s <a href="https://npmjs.org/package/html5" target="_blank" rel="noopener">html5</a> parser, as a prelude toward maybe eventually making this the default and fixing various parsing bugs.</li>
</ul>
<h2>0.3.1 (hotfix)</h2>
<ul>
...
<li>Fix: cssstyle was causing out-of-memory errors on some larger real-world pages, e.g. <a href="http://reddit.com" target="_blank" rel="noopener">reddit.com</a>.</li>
</ul>
<h2>0.2.16</h2>
<ul>
...
<li>Add: upgrade sizzle from 1.0 to <a href="https://github.com/jquery/sizzle/commit/fe2f618106bb76857b229113d6d11653707d0b22" target="_blank" rel="noopener">fe2f6181</a> which is roughly 1.5.1</li>
