    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>anymatch <a href="https://travis-ci.org/micromatch/anymatch" target="_blank" rel="noopener"><img src="https://travis-ci.org/micromatch/anymatch.svg?branch=master" alt="Build Status"></a> <a href="https://coveralls.io/r/micromatch/anymatch?branch=master" target="_blank" rel="noopener"><img src="https://img.shields.io/coveralls/micromatch/anymatch.svg?branch=master" alt="Coverage Status"></a></h1>
...
<p><strong>Note: This module has Bash-parity, please be aware that Windows-style backslashes are not supported as separators. See <a href="https://github.com/micromatch/micromatch#backslashes" target="_blank" rel="noopener">https://github.com/micromatch/micromatch#backslashes</a> for more information.</strong></p>
<p><a href="https://nodei.co/npm/anymatch/" target="_blank" rel="noopener"><img src="https://nodei.co/npm/anymatch.png?downloads=true&amp;downloadRank=true&amp;stars=true" alt="NPM"></a>
<a href="https://nodei.co/npm-dl/anymatch/" target="_blank" rel="noopener"><img src="https://nodei.co/npm-dl/anymatch.png?height=3&amp;months=9" alt="NPM"></a></p>
<h2>Usage</h2>
<pre class="hljs"><code>npm install anymatch --save
</code></pre>
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> anymatch = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;anymatch&apos;</span>);
...
<span class="hljs-keyword">var</span> matchers = [
	...
	<span class="hljs-regexp">/foo\.js$/</span>,
...
<pre class="hljs"><code><span class="hljs-keyword">var</span> matcher = anymatch(matchers);
...
<h2>Change Log</h2>
<p><a href="https://github.com/micromatch/anymatch/releases" target="_blank" rel="noopener">See release notes page on GitHub</a></p>
<p>NOTE: As of v2.0.0, <a href="https://github.com/jonschlinkert/micromatch" target="_blank" rel="noopener">micromatch</a> moves away from minimatch-parity and inline with Bash. This includes handling backslashes differently (see <a href="https://github.com/micromatch/micromatch#backslashes" target="_blank" rel="noopener">https://github.com/micromatch/micromatch#backslashes</a> for more information).</p>
<p>NOTE: As of v1.2.0, anymatch uses <a href="https://github.com/jonschlinkert/micromatch" target="_blank" rel="noopener">micromatch</a>
for glob pattern matching. Issues with glob pattern matching should be
reported directly to the <a href="https://github.com/jonschlinkert/micromatch/issues" target="_blank" rel="noopener">micromatch issue tracker</a>.</p>
<h2>License</h2>
<p><a href="https://raw.github.com/micromatch/anymatch/master/LICENSE" target="_blank" rel="noopener">ISC</a></p>
</body></html></div>
        </main>
      </div>
    </div>
