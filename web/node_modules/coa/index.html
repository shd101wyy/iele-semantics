    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>Command-Option-Argument</h1>
<p>Yet another parser for command line options.</p>
<p><a href="https://www.npmjs.org/package/coa" target="_blank" rel="noopener"><img src="https://img.shields.io/npm/v/coa.svg" alt="NPM Status"></a>
<a href="https://travis-ci.org/veged/coa" target="_blank" rel="noopener"><img src="https://img.shields.io/travis/veged/coa.svg" alt="Travis Status"></a>
<a href="https://ci.appveyor.com/project/zxqfox/coa" target="_blank" rel="noopener"><img src="https://ci.appveyor.com/api/projects/status/github/veged/coa?svg=true" alt="AppVeyor Status"></a>
<a href="https://coveralls.io/r/veged/coa" target="_blank" rel="noopener"><img src="https://img.shields.io/coveralls/veged/coa.svg" alt="Coverage Status"></a>
<a href="https://david-dm.org/veged/coa" target="_blank" rel="noopener"><img src="http://img.shields.io/david/veged/coa.svg" alt="Dependency Status"></a></p>
<h2>What is it?</h2>
...
<li>Commands can be async throught using promising (powered by <a href="https://github.com/kriskowal/q" target="_blank" rel="noopener">Q</a>)</li>
...
<h2>Examples</h2>
<pre class="hljs"><code><span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;coa&apos;</span>).Cmd() <span class="hljs-comment">// main (top level) command declaration</span>
...
<pre class="hljs"><code><span class="hljs-comment">// subcommand.js</span>
<span class="hljs-built_in">exports</span>.COA = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
...
<h4><a href="http://Cmd.name" target="_blank" rel="noopener">Cmd.name</a></h4>
...
<h4><a href="http://Opt.name" target="_blank" rel="noopener">Opt.name</a></h4>
...
<h4><a href="http://Arg.name" target="_blank" rel="noopener">Arg.name</a></h4>
