    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../../../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>How to Write Custom Syntax</h1>
...
<h2>Syntax</h2>
<p>A good example of a custom syntax is <a href="https://github.com/postcss/postcss-scss" target="_blank" rel="noopener">SCSS</a>. Some users may want to transform
...
<h2>Parser</h2>
<p>A good example of a parser is <a href="https://github.com/postcss/postcss-safe-parser" target="_blank" rel="noopener">Safe Parser</a>, which parses malformed/broken CSS.
Because there is no point to generate broken output, this package only provides
a parser.</p>
<p>The parser API is a function which receives a string &amp; returns a <a href="http://api.postcss.org/Root.html" target="_blank" rel="noopener"><code>Root</code></a> node.
The second argument is a function which receives an object with PostCSS options.</p>
<pre class="hljs"><code><span class="hljs-keyword">var</span> postcss = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;postcss&apos;</span>);

<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">css, opts</span>) </span>{
    <span class="hljs-keyword">var</span> root = postcss.root();
...
<ol>
<li><a href="https://github.com/postcss/postcss/blob/master/lib/tokenize.es6" target="_blank" rel="noopener">Tokenizer</a> which reads input string character by character and builds a
tokens array. For example, it joins space symbols to a <code>[&apos;space&apos;, &apos;\n  &apos;]</code>
token, and detects strings to a <code>[&apos;string&apos;, &apos;&quot;\&quot;{&quot;&apos;]</code> token.</li>
<li><a href="https://github.com/postcss/postcss/blob/master/lib/parser.es6" target="_blank" rel="noopener">Parser</a> which reads the tokens array, creates node instances and
builds a tree.</li>
</ol>
<h3>Performance</h3>
...
benchmark. You can look at <a href="https://github.com/postcss/benchmark" target="_blank" rel="noopener">PostCSS benchmarks</a> to build your own.</p>
...
default <a href="https://github.com/postcss/postcss/blob/master/lib/tokenize.es6" target="_blank" rel="noopener">PostCSS tokenizer</a>; copy &amp; paste will be a necessary evil.</p>
<p>Second optimization is using character codes instead of strings.</p>
<pre class="hljs"><code><span class="hljs-comment">// Slow</span>
...
<pre class="hljs"><code><span class="hljs-comment">// Simple jump</span>
...
hardcore optimization there. You can extend the default <a href="https://github.com/postcss/postcss/blob/master/lib/parser.es6" target="_blank" rel="noopener">PostCSS parser</a>.</p>
<h3>Node Source</h3>
...
and <code>input</code> property with an <a href="https://github.com/postcss/postcss/blob/master/lib/input.es6" target="_blank" rel="noopener"><code>Input</code></a> instance.</p>
...
For example, <a href="https://github.com/postcss/postcss-scss" target="_blank" rel="noopener">SCSS parser</a> saves comment types (<code>/* */</code> or <code>//</code>)
...
<p>If your parser just extends CSS syntax (like <a href="https://github.com/postcss/postcss-scss" target="_blank" rel="noopener">SCSS</a> or <a href="https://github.com/postcss/postcss-safe-parser" target="_blank" rel="noopener">Safe Parser</a>),
you can use the <a href="https://github.com/postcss/postcss-parser-tests" target="_blank" rel="noopener">PostCSS Parser Tests</a>. It contains unit &amp; integration tests.</p>
<h2>Stringifier</h2>
...
<p>A Stringifier is a function which receives <a href="http://api.postcss.org/Root.html" target="_blank" rel="noopener"><code>Root</code></a> node and builder callback.
Then it calls builder with every node&#x2019;s string and node instance.</p>
<pre class="hljs"><code><span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">root, builder</span>) </span>{
    <span class="hljs-comment">// Some magic</span>
    <span class="hljs-keyword">var</span> string = decl.prop + <span class="hljs-string">&apos;:&apos;</span> + decl.value + <span class="hljs-string">&apos;;&apos;</span>;
    builder(string, decl);
    <span class="hljs-comment">// Some science</span>
};
</code></pre>
<h3>Main Theory</h3>
<p>PostCSS <a href="https://github.com/postcss/postcss/blob/master/lib/stringifier.es6" target="_blank" rel="noopener">default stringifier</a> is just a class with a method for each node type
and many methods to detect raw properties.</p>
<p>In most cases it will be enough just to extend this class,
like in <a href="https://github.com/postcss/postcss-scss/blob/master/lib/scss-stringifier.es6" target="_blank" rel="noopener">SCSS stringifier</a>.</p>
...
<pre class="hljs"><code><span class="hljs-built_in">this</span>.builder(rule.selector + <span class="hljs-string">&apos;{&apos;</span>, rule, <span class="hljs-string">&apos;start&apos;</span>);
<span class="hljs-comment">// Stringify declarations inside</span>
<span class="hljs-built_in">this</span>.builder(<span class="hljs-string">&apos;}&apos;</span>, rule, <span class="hljs-string">&apos;end&apos;</span>);
</code></pre>
<h3>Raw Values</h3>
...
<p>You can use unit and integration test cases from <a href="https://github.com/postcss/postcss-parser-tests" target="_blank" rel="noopener">PostCSS Parser Tests</a>.
