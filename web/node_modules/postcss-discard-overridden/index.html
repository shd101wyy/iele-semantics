    ...
    <div class="bd-toc-item">
      ...
      <a class="bd-toc-link" href="../../../Design">Design</a>
        ...
        <main
          ...
          role="main"
        >
          <div class="markdown-preview"><html><head></head><body><h1>PostCSS Discard Overridden</h1>
<p><a href="https://github.com/postcss/postcss" target="_blank" rel="noopener">PostCSS</a> plugin to discard overridden <code>@keyframes</code> or <code>@counter-style</code>.</p>
...
<pre class="hljs"><code><span class="hljs-keyword">@-webkit-keyframes</span> fade-in {
  0% {
...
<span class="hljs-keyword">@media</span> (<span class="hljs-attribute">max-width:</span> <span class="hljs-number">500px</span>) {
  <span class="hljs-keyword">@-webkit-keyframes</span> fade-in {
    0% {
      <span class="hljs-attribute">opacity</span>: <span class="hljs-number">0</span>;
    }
    100% {
...
<pre class="hljs"><code><span class="hljs-keyword">@media</span> (<span class="hljs-attribute">max-width:</span> <span class="hljs-number">500px</span>) {
  <span class="hljs-keyword">@-webkit-keyframes</span> fade-in {
    0% {
      <span class="hljs-attribute">opacity</span>: <span class="hljs-number">0</span>;
    }
